...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 19 sep. 2024 à 09:09
...
--
-- Base de données : `sc2sylg_erp24`
--

-- --------------------------------------------------------

--
-- Structure de la table `erp_accounting_account`
--
...
--
-- Structure de la table `erp_accounting_bookkeeping`
--
...
--
-- Structure de la table `erp_accounting_bookkeeping_tmp`
--
...
--
-- Structure de la table `erp_accounting_fiscalyear`
--
...
--
-- Structure de la table `erp_accounting_groups_account`
--
...
--
-- Structure de la table `erp_accounting_journal`
--
...
--
-- Déchargement des données de la table `erp_accounting_journal`
--
...
--
-- Structure de la table `erp_accounting_system`
--
...
--
-- Déchargement des données de la table `erp_accounting_system`
--
...
--
-- Structure de la table `erp_actioncomm`
--
...
--
-- Structure de la table `erp_actioncomm_extrafields`
--
...
--
-- Structure de la table `erp_actioncomm_reminder`
--
...
--
-- Structure de la table `erp_actioncomm_resources`
--
...
--
-- Structure de la table `erp_adherent`
--
...
--
-- Structure de la table `erp_adherent_extrafields`
--
...
--
-- Structure de la table `erp_adherent_type`
--
...
--
-- Structure de la table `erp_adherent_type_extrafields`
--
...
--
-- Structure de la table `erp_adherent_type_lang`
--
...
--
-- Structure de la table `erp_bank`
--
...
--
-- Structure de la table `erp_bank_account`
--
...
--
-- Structure de la table `erp_bank_account_extrafields`
--
...
--
-- Structure de la table `erp_bank_categ`
--
...
--
-- Structure de la table `erp_bank_class`
--
...
--
-- Structure de la table `erp_bank_extrafields`
--

CREATE TABLE `erp_bank_extrafields` (
  `rowid` int(11) NOT NULL,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL
...
--
-- Structure de la table `erp_bank_url`
--
...
--
-- Structure de la table `erp_blockedlog`
--
...
--
-- Structure de la table `erp_blockedlog_authority`
--
...
--
-- Structure de la table `erp_bom_bom`
--
...
--
-- Structure de la table `erp_bom_bomline`
--
...
--
-- Structure de la table `erp_bom_bomline_extrafields`
--
...
--
-- Structure de la table `erp_bom_bom_extrafields`
--
...
--
-- Structure de la table `erp_bookmark`
--
...
--
-- Structure de la table `erp_bordereau_cheque`
--
...
--
-- Structure de la table `erp_boxes`
--
...
--
-- Déchargement des données de la table `erp_boxes`
--
...
--
-- Structure de la table `erp_boxes_def`
--
...
--
-- Déchargement des données de la table `erp_boxes_def`
--

INSERT INTO `erp_boxes_def` (`rowid`, `file`, `entity`, `fk_user`, `tms`, `note`) VALUES
(1, 'box_lastlogin.php', 1, 0, '2024-09-18 19:11:42', NULL),
(2, 'box_birthdays.php', 1, 0, '2024-09-18 19:11:42', NULL),
(3, 'box_dolibarr_state_board.php', 1, 0, '2024-09-18 19:11:42', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `erp_categorie`
--
...
--
-- Structure de la table `erp_categories_extrafields`
--
...
--
-- Structure de la table `erp_categorie_account`
--
...
--
-- Structure de la table `erp_categorie_actioncomm`
--
...
--
-- Structure de la table `erp_categorie_contact`
--
...
--
-- Structure de la table `erp_categorie_fournisseur`
--
...
--
-- Structure de la table `erp_categorie_lang`
--
...
--
-- Structure de la table `erp_categorie_member`
--
...
--
-- Structure de la table `erp_categorie_product`
--
...
--
-- Structure de la table `erp_categorie_project`
--
...
--
-- Structure de la table `erp_categorie_societe`
--
...
--
-- Structure de la table `erp_categorie_user`
--
...
--
-- Structure de la table `erp_categorie_warehouse`
--
...
--
-- Structure de la table `erp_chargesociales`
--
...
--
-- Structure de la table `erp_commande`
--
...
--
-- Structure de la table `erp_commandedet`
--
...
--
-- Structure de la table `erp_commandedet_extrafields`
--
...
--
-- Structure de la table `erp_commande_extrafields`
--
...
--
-- Structure de la table `erp_commande_fournisseur`
--
...
--
-- Structure de la table `erp_commande_fournisseurdet`
--
...
--
-- Structure de la table `erp_commande_fournisseurdet_extrafields`
--
...
--
-- Structure de la table `erp_commande_fournisseur_dispatch`
--
...
--
-- Structure de la table `erp_commande_fournisseur_dispatch_extrafields`
--
...
--
-- Structure de la table `erp_commande_fournisseur_extrafields`
--
...
--
-- Structure de la table `erp_commande_fournisseur_log`
--
...
--
-- Structure de la table `erp_comment`
--
...
--
-- Structure de la table `erp_const`
--
...
--
-- Déchargement des données de la table `erp_const`
--

INSERT INTO `erp_const` (`rowid`, `name`, `entity`, `value`, `type`, `visible`, `note`, `tms`) VALUES
(2, 'MAIN_FEATURES_LEVEL', 0, '0', 'chaine', 1, 'Level of features to show: -1=stable+deprecated, 0=stable only (default), 1=stable+experimental, 2=stable+experimental+development', '2024-09-18 19:11:42'),
(3, 'MAILING_LIMIT_SENDBYWEB', 0, '25', 'chaine', 1, 'Number of targets to defined packet size when sending mass email', '2024-09-18 19:11:42'),
(4, 'SYSLOG_HANDLERS', 0, '[\"mod_syslog_file\"]', 'chaine', 0, 'Which logger to use', '2024-09-18 19:11:42'),
(5, 'SYSLOG_FILE', 0, 'DOL_DATA_ROOT/dolibarr.log', 'chaine', 0, 'Directory where to write log file', '2024-09-18 19:11:42'),
(6, 'SYSLOG_LEVEL', 0, '7', 'chaine', 0, 'Level of debug info to show', '2024-09-18 19:11:42'),
(7, 'MAIN_UPLOAD_DOC', 0, '2048', 'chaine', 0, 'Max size for file upload (0 means no upload allowed)', '2024-09-18 19:11:42'),
(8, 'MAIN_ENABLE_OVERWRITE_TRANSLATION', 1, '1', 'chaine', 0, 'Enable translation overwrite', '2024-09-18 19:11:42'),
(9, 'MAIN_ENABLE_DEFAULT_VALUES', 1, '1', 'chaine', 0, 'Enable default value overwrite', '2024-09-18 19:11:42'),
(10, 'MAIN_MONNAIE', 1, 'EUR', 'chaine', 0, 'Currency', '2024-09-18 19:11:42'),
(11, 'MAIN_MAIL_SMTP_SERVER', 1, '', 'chaine', 0, 'Host or ip address for SMTP server', '2024-09-18 19:11:42'),
(12, 'MAIN_MAIL_SMTP_PORT', 1, '', 'chaine', 0, 'Port for SMTP server', '2024-09-18 19:11:42'),
(13, 'MAIN_MAIL_EMAIL_FROM', 1, 'robot@domain.com', 'chaine', 0, 'email emitter for Dolibarr automatic emails', '2024-09-18 19:11:42'),
(14, 'MAIN_SIZE_LISTE_LIMIT', 0, '20', 'chaine', 0, 'Maximum length of lists', '2024-09-18 19:11:42'),
(15, 'MAIN_SIZE_SHORTLIST_LIMIT', 0, '3', 'chaine', 0, 'Maximum length of short lists', '2024-09-18 19:11:42'),
(16, 'MAIN_MENU_STANDARD', 0, 'eldy_menu.php', 'chaine', 0, 'Menu manager for internal users', '2024-09-18 19:11:42'),
(17, 'MAIN_MENUFRONT_STANDARD', 0, 'eldy_menu.php', 'chaine', 0, 'Menu manager for external users', '2024-09-18 19:11:42'),
(18, 'MAIN_MENU_SMARTPHONE', 0, 'eldy_menu.php', 'chaine', 0, 'Menu manager for internal users using smartphones', '2024-09-18 19:11:42'),
(19, 'MAIN_MENUFRONT_SMARTPHONE', 0, 'eldy_menu.php', 'chaine', 0, 'Menu manager for external users using smartphones', '2024-09-18 19:11:42'),
(20, 'THEME_ELDY_USEBORDERONTABLE', 0, '1', 'chaine', 0, 'Enable the border in theme', '2024-09-18 19:11:42'),
(21, 'MAIN_DELAY_ACTIONS_TODO', 1, '7', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur actions planifiées non réalisées', '2024-09-18 19:11:42'),
(22, 'MAIN_DELAY_ORDERS_TO_PROCESS', 1, '2', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur commandes clients non traitées', '2024-09-18 19:11:42'),
(23, 'MAIN_DELAY_SUPPLIER_ORDERS_TO_PROCESS', 1, '7', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur commandes fournisseurs non traitées', '2024-09-18 19:11:42'),
(24, 'MAIN_DELAY_PROPALS_TO_CLOSE', 1, '31', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur propales à cloturer', '2024-09-18 19:11:42'),
(25, 'MAIN_DELAY_PROPALS_TO_BILL', 1, '7', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur propales non facturées', '2024-09-18 19:11:42'),
(26, 'MAIN_DELAY_CUSTOMER_BILLS_UNPAYED', 1, '31', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur factures client impayées', '2024-09-18 19:11:42'),
(27, 'MAIN_DELAY_SUPPLIER_BILLS_TO_PAY', 1, '2', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur factures fournisseur impayées', '2024-09-18 19:11:42'),
(28, 'MAIN_DELAY_NOT_ACTIVATED_SERVICES', 1, '0', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur services à activer', '2024-09-18 19:11:42'),
(29, 'MAIN_DELAY_RUNNING_SERVICES', 1, '0', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur services expirés', '2024-09-18 19:11:42'),
(30, 'MAIN_DELAY_MEMBERS', 1, '31', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur cotisations adhérent en retard', '2024-09-18 19:11:42'),
(31, 'MAIN_DELAY_TRANSACTIONS_TO_CONCILIATE', 1, '62', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur rapprochements bancaires à faire', '2024-09-18 19:11:42'),
(32, 'MAIN_DELAY_EXPENSEREPORTS_TO_PAY', 1, '31', 'chaine', 0, 'Tolérance de retard avant alerte (en jours) sur les notes de frais impayées', '2024-09-18 19:11:42'),
(33, 'MAILING_EMAIL_FROM', 1, 'no-reply@mydomain.com', 'chaine', 0, 'EMail emmetteur pour les envois d emailings', '2024-09-18 19:11:42'),
(34, 'PRODUCT_ADDON_PDF_ODT_PATH', 1, 'DOL_DATA_ROOT/doctemplates/products', 'chaine', 0, NULL, '2024-09-18 19:11:42'),
(35, 'CONTRACT_ADDON_PDF_ODT_PATH', 1, 'DOL_DATA_ROOT/doctemplates/contracts', 'chaine', 0, NULL, '2024-09-18 19:11:42'),
(36, 'USERGROUP_ADDON_PDF_ODT_PATH', 1, 'DOL_DATA_ROOT/doctemplates/usergroups', 'chaine', 0, NULL, '2024-09-18 19:11:42'),
(37, 'USER_ADDON_PDF_ODT_PATH', 1, 'DOL_DATA_ROOT/doctemplates/users', 'chaine', 0, NULL, '2024-09-18 19:11:42'),
(38, 'PRODUCT_PRICE_BASE_TYPE', 0, 'HT', 'string', 0, NULL, '2024-09-18 19:11:42'),
(39, 'ADHERENT_LOGIN_NOT_REQUIRED', 0, '1', 'string', 0, NULL, '2024-09-18 19:11:42'),
(40, 'MAIN_MODULE_USER', 0, '1', 'string', 0, '{\"authorid\":0,\"ip\":\"41.74.208.220\",\"lastactivationversion\":\"dolibarr\"}', '2024-09-18 19:11:42'),
(41, 'DATABASE_PWD_ENCRYPTED', 1, '1', 'chaine', 0, '', '2024-09-18 19:11:42'),
(42, 'MAIN_SECURITY_SALT', 0, '20240918191139', 'chaine', 0, '', '2024-09-18 19:11:42'),
(43, 'MAIN_SECURITY_HASH_ALGO', 0, 'password_hash', 'chaine', 0, '', '2024-09-18 19:11:42'),
(44, 'MAIN_VERSION_FIRST_INSTALL', 0, '19.0.3', 'chaine', 0, 'Dolibarr version when first install', '2024-09-18 19:11:42'),
(45, 'MAIN_VERSION_LAST_INSTALL', 0, '19.0.3', 'chaine', 0, 'Dolibarr version when last install', '2024-09-18 19:11:42'),
(46, 'MAIN_MODULE_FCKEDITOR', 1, '1', 'string', 0, '{\"authorid\":0,\"ip\":\"41.74.208.220\",\"lastactivationversion\":\"dolibarr\"}', '2024-09-18 19:11:42'),
(47, 'FCKEDITOR_ENABLE_SOCIETE', 1, '1', 'yesno', 0, 'WYSIWIG for the fields descriptions of elements (except products/services)', '2024-09-18 19:11:42'),
(48, 'FCKEDITOR_ENABLE_DETAILS', 1, '1', 'yesno', 0, 'WYSIWIG for products details lines for all entities', '2024-09-18 19:11:42'),
(49, 'FCKEDITOR_ENABLE_USERSIGN', 1, '1', 'yesno', 0, 'WYSIWIG for user signature', '2024-09-18 19:11:42'),
(50, 'FCKEDITOR_ENABLE_MAILING', 1, '1', 'yesno', 0, 'WYSIWIG for mass emailings', '2024-09-18 19:11:42'),
(51, 'FCKEDITOR_ENABLE_MAIL', 1, '1', 'yesno', 0, 'WYSIWIG for products details lines for all entities', '2024-09-18 19:11:42'),
(52, 'MAIN_MODULE_IMPORT', 1, '1', 'string', 0, '{\"authorid\":0,\"ip\":\"41.74.208.220\",\"lastactivationversion\":\"dolibarr\"}', '2024-09-18 19:11:42'),
(53, 'MAIN_MODULE_EXPORT', 1, '1', 'string', 0, '{\"authorid\":0,\"ip\":\"41.74.208.220\",\"lastactivationversion\":\"dolibarr\"}', '2024-09-18 19:11:42'),
(54, 'MAIN_LANG_DEFAULT', 1, 'fr_FR', 'chaine', 0, 'Default language', '2024-09-18 19:11:42');

-- --------------------------------------------------------

--
-- Structure de la table `erp_contrat`
--
...
--
-- Structure de la table `erp_contratdet`
--
...
--
-- Structure de la table `erp_contratdet_extrafields`
--
...
--
-- Structure de la table `erp_contratdet_log`
--
...
--
-- Structure de la table `erp_contrat_extrafields`
--
...
--
-- Structure de la table `erp_cronjob`
--
...
--
-- Structure de la table `erp_c_accounting_category`
--
...
--
-- Déchargement des données de la table `erp_c_accounting_category`
--
...
--
-- Structure de la table `erp_c_actioncomm`
--
...
--
-- Déchargement des données de la table `erp_c_actioncomm`
--
...
--
-- Structure de la table `erp_c_action_trigger`
--
...
--
-- Déchargement des données de la table `erp_c_action_trigger`
--

INSERT INTO `erp_c_action_trigger` (`rowid`, `elementtype`, `code`, `contexts`, `label`, `description`, `rang`) VALUES
...
--
-- Structure de la table `erp_c_availability`
--
...
--
-- Déchargement des données de la table `erp_c_availability`
--

INSERT INTO `erp_c_availability` (`rowid`, `code`, `label`, `type_duration`, `qty`, `active`, `position`) VALUES
...
--
-- Structure de la table `erp_c_barcode_type`
--
...
--
-- Structure de la table `erp_c_chargesociales`
--
...
--
-- Déchargement des données de la table `erp_c_chargesociales`
--
...
--
-- Structure de la table `erp_c_civility`
--
...
--
-- Déchargement des données de la table `erp_c_civility`
--
...
--
-- Structure de la table `erp_c_country`
--
...
--
-- Déchargement des données de la table `erp_c_country`
--

INSERT INTO `erp_c_country` (`rowid`, `code`, `code_iso`, `numeric_code`, `label`, `eec`, `active`, `favorite`) VALUES
(0, '', NULL, NULL, '-', 0, 1, 1),
...
--
-- Structure de la table `erp_c_currencies`
--
...
--
-- Déchargement des données de la table `erp_c_currencies`
--
...
--
-- Structure de la table `erp_c_departements`
--
...
--
-- Déchargement des données de la table `erp_c_departements`
--
...
--
-- Structure de la table `erp_c_ecotaxe`
--
...
--
-- Déchargement des données de la table `erp_c_ecotaxe`
--
...
--
-- Structure de la table `erp_c_effectif`
--
...
--
-- Déchargement des données de la table `erp_c_effectif`
--
...
--
-- Structure de la table `erp_c_email_senderprofile`
--
...
--
-- Structure de la table `erp_c_email_templates`
--
...
--
-- Déchargement des données de la table `erp_c_email_templates`
--

INSERT INTO `erp_c_email_templates` (`rowid`, `entity`, `module`, `type_template`, `lang`, `private`, `fk_user`, `datec`, `tms`, `label`, `position`, `defaultfortype`, `enabled`, `active`, `email_from`, `email_to`, `email_tocc`, `email_tobcc`, `topic`, `joinfiles`, `content`, `content_lines`) VALUES
(1, 0, 'banque', 'thirdparty', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(YourSEPAMandate)', 1, 0, 'isModEnabled(\"societe\") && isModEnabled(\"banque\") && isModEnabled(\"prelevement\")', 0, NULL, NULL, NULL, NULL, '__(YourSEPAMandate)__', '0', '__(Hello)__,<br><br>\n\n__(FindYourSEPAMandate)__ :<br>\n__MYCOMPANY_NAME__<br>\n__MYCOMPANY_FULLADDRESS__<br><br>\n__(Sincerely)__<br>\n__USER_SIGNATURE__', NULL),
(2, 0, 'adherent', 'member', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingEmailOnAutoSubscription)', 10, 0, 'isModEnabled(\"adherent\")', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(YourMembershipRequestWasReceived)__', '0', '__(Hello)__ __MEMBER_FULLNAME__,<br><br>\n\n__(ThisIsContentOfYourMembershipRequestWasReceived)__<br>\n<br>__ONLINE_PAYMENT_TEXT_AND_URL__<br>\n<br><br>\n__(Sincerely)__<br>__USER_SIGNATURE__', NULL),
(3, 0, 'adherent', 'member', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingEmailOnMemberValidation)', 20, 0, 'isModEnabled(\"adherent\")', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(YourMembershipWasValidated)__', '0', '__(Hello)__ __MEMBER_FULLNAME__,<br><br>\n\n__(ThisIsContentOfYourMembershipWasValidated)__<br>__(FirstName)__ : __MEMBER_FIRSTNAME__<br>__(LastName)__ : __MEMBER_LASTNAME__<br>__(ID)__ : __MEMBER_ID__<br>\n<br>__ONLINE_PAYMENT_TEXT_AND_URL__<br>\n<br><br>\n__(Sincerely)__<br>__USER_SIGNATURE__', NULL),
(4, 0, 'adherent', 'member', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingEmailOnNewSubscription)', 30, 0, 'isModEnabled(\"adherent\")', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(YourSubscriptionWasRecorded)__', '1', '__(Hello)__ __MEMBER_FULLNAME__,<br><br>\n\n__(ThisIsContentOfYourSubscriptionWasRecorded)__<br>\n\n<br><br>\n__(Sincerely)__<br>__USER_SIGNATURE__', NULL),
(5, 0, 'adherent', 'member', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingReminderForExpiredSubscription)', 40, 0, 'isModEnabled(\"adherent\")', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(SubscriptionReminderEmail)__', '0', '__(Hello)__ __MEMBER_FULLNAME__,<br><br>\n\n__(ThisIsContentOfSubscriptionReminderEmail)__<br>\n<br>__ONLINE_PAYMENT_TEXT_AND_URL__<br>\n<br><br>\n__(Sincerely)__<br>__USER_SIGNATURE__', NULL),
(6, 0, 'adherent', 'member', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingEmailOnCancelation)', 50, 0, 'isModEnabled(\"adherent\")', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(YourMembershipWasCanceled)__', '0', '__(Hello)__ __MEMBER_FULLNAME__,<br><br>\n\n__(YourMembershipWasCanceled)__<br>\n<br><br>\n__(Sincerely)__<br>__USER_SIGNATURE__', NULL),
(7, 0, 'adherent', 'member', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingAnEMailToMember)', 60, 0, 'isModEnabled(\"adherent\")', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(CardContent)__', '0', '__(Hello)__,<br><br>\n\n__(ThisIsContentOfYourCard)__<br>\n__(ID)__ : __ID__<br>\n__(Civility)__ : __MEMBER_CIVILITY__<br>\n__(Firstname)__ : __MEMBER_FIRSTNAME__<br>\n__(Lastname)__ : __MEMBER_LASTNAME__<br>\n__(Fullname)__ : __MEMBER_FULLNAME__<br>\n__(Company)__ : __MEMBER_COMPANY__<br>\n__(Address)__ : __MEMBER_ADDRESS__<br>\n__(Zip)__ : __MEMBER_ZIP__<br>\n__(Town)__ : __MEMBER_TOWN__<br>\n__(Country)__ : __MEMBER_COUNTRY__<br>\n__(Email)__ : __MEMBER_EMAIL__<br>\n__(Birthday)__ : __MEMBER_BIRTH__<br>\n__(Photo)__ : __MEMBER_PHOTO__<br>\n__(Login)__ : __MEMBER_LOGIN__<br>\n__(Phone)__ : __MEMBER_PHONE__<br>\n__(PhonePerso)__ : __MEMBER_PHONEPRO__<br>\n__(PhoneMobile)__ : __MEMBER_PHONEMOBILE__<br><br>\n__(Sincerely)__<br>__USER_SIGNATURE__', NULL),
(8, 0, 'recruitment', 'recruitmentcandidature_send', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(AnswerCandidature)', 100, 0, 'isModEnabled(\"recruitment\")', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(YourCandidature)__', '0', '__(Hello)__ __CANDIDATE_FULLNAME__,<br><br>\n\n__(YourCandidatureAnswerMessage)__<br>__ONLINE_INTERVIEW_SCHEDULER_TEXT_AND_URL__\n<br><br>\n__(Sincerely)__<br>__USER_SIGNATURE__', NULL),
(9, 0, '', 'conferenceorbooth', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(EventOrganizationEmailAskConf)', 10, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(EventOrganizationEmailAskConf)__', NULL, '__(Hello)__,<br /><br />__(OrganizationEventConfRequestWasReceived)__<br /><br /><br />__(Sincerely)__<br />__USER_SIGNATURE__', NULL),
(10, 0, '', 'conferenceorbooth', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(EventOrganizationEmailAskBooth)', 20, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(EventOrganizationEmailAskBooth)__', NULL, '__(Hello)__,<br /><br />__(OrganizationEventBoothRequestWasReceived)__<br /><br /><br />__(Sincerely)__<br />__USER_SIGNATURE__', NULL),
(11, 0, '', 'conferenceorbooth', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(EventOrganizationEmailBoothPayment)', 30, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(EventOrganizationEmailBoothPayment)__', NULL, '__(Hello)__,<br /><br />__(OrganizationEventPaymentOfBoothWasReceived)__<br /><br /><br />__(Sincerely)__<br />__USER_SIGNATURE__', NULL),
(12, 0, '', 'conferenceorbooth', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(EventOrganizationEmailRegistrationPayment)', 40, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(EventOrganizationEmailRegistrationPayment)__', NULL, '__(Hello)__,<br /><br />__(OrganizationEventPaymentOfRegistrationWasReceived)__<br /><br />__(Sincerely)__<br />__USER_SIGNATURE__', NULL),
(13, 0, '', 'conferenceorbooth', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(EventOrganizationMassEmailAttendees)', 50, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(EventOrganizationMassEmailAttendees)__', NULL, '__(Hello)__,<br /><br />__(OrganizationEventBulkMailToAttendees)__<br /><br />__(Sincerely)__<br />__USER_SIGNATURE__', NULL),
(14, 0, '', 'conferenceorbooth', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(EventOrganizationMassEmailSpeakers)', 60, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] __(EventOrganizationMassEmailSpeakers)__', NULL, '__(Hello)__,<br /><br />__(OrganizationEventBulkMailToSpeakers)__<br /><br />__(Sincerely)__<br />__USER_SIGNATURE__', NULL),
(15, 0, 'partnership', 'partnership_send', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingEmailOnPartnershipWillSoonBeCanceled)', 100, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] - __(YourPartnershipWillSoonBeCanceledTopic)__', '0', '<body>\n <p>__(Hello)__,<br><br>\n__(YourPartnershipWillSoonBeCanceledContent)__</p>\n<br />\n\n<br />\n\n            __(Sincerely)__ <br />\n            __[MAIN_INFO_SOCIETE_NOM]__ <br />\n </body>\n', NULL),
(16, 0, 'partnership', 'partnership_send', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingEmailOnPartnershipCanceled)', 100, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] - __(YourPartnershipCanceledTopic)__', '0', '<body>\n <p>__(Hello)__,<br><br>\n__(YourPartnershipCanceledContent)__</p>\n<br />\n\n<br />\n\n            __(Sincerely)__ <br />\n            __[MAIN_INFO_SOCIETE_NOM]__ <br />\n </body>\n', NULL),
(17, 0, 'partnership', 'partnership_send', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingEmailOnPartnershipRefused)', 100, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] - __(YourPartnershipRefusedTopic)__', '0', '<body>\n <p>__(Hello)__,<br><br>\n__(YourPartnershipRefusedContent)__</p>\n<br />\n\n<br />\n\n            __(Sincerely)__ <br />\n            __[MAIN_INFO_SOCIETE_NOM]__ <br />\n </body>\n', NULL),
(18, 0, 'partnership', 'partnership_send', '', 0, NULL, NULL, '2024-09-18 19:11:42', '(SendingEmailOnPartnershipAccepted)', 100, 0, '1', 1, NULL, NULL, NULL, NULL, '[__[MAIN_INFO_SOCIETE_NOM]__] - __(YourPartnershipAcceptedTopic)__', '0', '<body>\n <p>__(Hello)__,<br><br>\n__(YourPartnershipAcceptedContent)__</p>\n<br />\n\n<br />\n\n            __(Sincerely)__ <br />\n            __[MAIN_INFO_SOCIETE_NOM]__ <br />\n </body>\n', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `erp_c_field_list`
--
...
--
-- Structure de la table `erp_c_format_cards`
--
...
--
-- Déchargement des données de la table `erp_c_format_cards`
--
...
--
-- Structure de la table `erp_c_forme_juridique`
--
...
--
-- Déchargement des données de la table `erp_c_forme_juridique`
--
...
--
-- Structure de la table `erp_c_holiday_types`
--
...
--
-- Déchargement des données de la table `erp_c_holiday_types`
--

INSERT INTO `erp_c_holiday_types` (`rowid`, `code`, `label`, `affect`, `delay`, `newbymonth`, `fk_country`, `block_if_negative`, `sortorder`, `active`) VALUES
...
--
-- Structure de la table `erp_c_hrm_department`
--
...
--
-- Déchargement des données de la table `erp_c_hrm_department`
--
...
--
-- Structure de la table `erp_c_hrm_function`
--
...
--
-- Déchargement des données de la table `erp_c_hrm_function`
--
...
--
-- Structure de la table `erp_c_hrm_public_holiday`
--
...
--
-- Déchargement des données de la table `erp_c_hrm_public_holiday`
--

INSERT INTO `erp_c_hrm_public_holiday` (`id`, `entity`, `fk_country`, `fk_departement`, `code`, `dayrule`, `day`, `month`, `year`, `active`, `import_key`) VALUES
...
--
-- Structure de la table `erp_c_incoterms`
--
...
--
-- Déchargement des données de la table `erp_c_incoterms`
--

INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (1, 'EXW', 'Ex Works', 'Ex Works, au départ non chargé, non dédouané sortie d usine (uniquement adapté aux flux domestiques, nationaux)', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (2, 'FCA', 'Free Carrier', 'Free Carrier, marchandises dédouanées et chargées dans le pays de départ, chez le vendeur ou chez le commissionnaire de transport de l acheteur', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (3, 'FAS', 'Free Alongside Ship', 'Free Alongside Ship, sur le quai du port de départ', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (4, 'FOB', 'Free On Board', 'Free On Board, chargé sur le bateau, les frais de chargement dans celui-ci étant fonction du liner term indiqué par la compagnie maritime (à la charge du vendeur)', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (5, 'CFR', 'Cost and Freight', 'Cost and Freight, chargé dans le bateau, livraison au port de départ, frais payés jusqu au port d arrivée, sans assurance pour le transport, non déchargé du navire à destination (les frais de déchargement sont inclus ou non au port d arrivée)', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (6, 'CIF', 'Cost, Insurance, Freight', 'Cost, Insurance and Freight, chargé sur le bateau, frais jusqu au port d arrivée, avec l assurance marchandise transportée souscrite par le vendeur pour le compte de l acheteur', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (7, 'CPT', 'Carriage Paid To', 'Carriage Paid To, livraison au premier transporteur, frais jusqu au déchargement du mode de transport, sans assurance pour le transport', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (8, 'CIP', 'Carriage Insurance Paid', 'Carriage and Insurance Paid to, idem CPT, avec assurance marchandise transportée souscrite par le vendeur pour le compte de l acheteur', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (9, 'DAT', 'Delivered At Terminal', 'Delivered At Terminal, marchandises (déchargées) livrées sur quai, dans un terminal maritime, fluvial, aérien, routier ou ferroviaire désigné (dédouanement import, et post-acheminement payés par l acheteur)', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (10, 'DAP', 'Delivered At Place', 'Delivered At Place, marchandises (non déchargées) mises à disposition de l acheteur dans le pays d importation au lieu précisé dans le contrat (déchargement, dédouanement import payé par l acheteur)', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (11, 'DDP', 'Delivered Duty Paid', 'Delivered Duty Paid, marchandises (non déchargées) livrées à destination finale, dédouanement import et taxes à la charge du vendeur, l acheteur prend en charge uniquement le déchargement (si exclusion des taxes type TVA, le préciser clairement)', 1);
INSERT INTO `erp_c_incoterms` (`rowid`, `code`, `label`, `libelle`, `active`) VALUES (12, 'DPU', 'Delivered at Place Unloaded', 'Delivered at Place unloaded', 1);

-- --------------------------------------------------------

--
-- Structure de la table `erp_c_input_method`
--
...
--
-- Déchargement des données de la table `erp_c_input_method`
--
...
--
-- Structure de la table `erp_c_input_reason`
--
...
--
-- Déchargement des données de la table `erp_c_input_reason`
--
...
--
-- Structure de la table `erp_c_invoice_subtype`
--

CREATE TABLE `erp_c_invoice_subtype` (
  `rowid` int(11) NOT NULL,
  `entity` int(11) NOT NULL DEFAULT 1,
...
--
-- Déchargement des données de la table `erp_c_invoice_subtype`
--

INSERT INTO `erp_c_invoice_subtype` (`rowid`, `entity`, `fk_country`, `code`, `label`, `active`) VALUES
...
--
-- Structure de la table `erp_c_lead_status`
--
...
--
-- Déchargement des données de la table `erp_c_lead_status`
--
...
--
-- Structure de la table `erp_c_paiement`
--
...
--
-- Déchargement des données de la table `erp_c_paiement`
--
...
--
-- Structure de la table `erp_c_paper_format`
--
...
--
-- Déchargement des données de la table `erp_c_paper_format`
--
...
--
-- Structure de la table `erp_c_payment_term`
--
...
--
-- Déchargement des données de la table `erp_c_payment_term`
--

INSERT INTO `erp_c_payment_term` (`rowid`, `entity`, `code`, `sortorder`, `active`, `libelle`, `libelle_facture`, `type_cdr`, `nbjour`, `decalage`, `deposit_percent`, `module`, `position`) VALUES
...
--
-- Structure de la table `erp_c_productbatch_qcstatus`
--
...
--
-- Déchargement des données de la table `erp_c_productbatch_qcstatus`
--
...
--
-- Structure de la table `erp_c_product_nature`
--
...
--
-- Déchargement des données de la table `erp_c_product_nature`
--
...
--
-- Structure de la table `erp_c_propalst`
--
...
--
-- Déchargement des données de la table `erp_c_propalst`
--

INSERT INTO `erp_c_propalst` (`id`, `code`, `label`, `sortorder`, `active`) VALUES
...
--
-- Structure de la table `erp_c_prospectcontactlevel`
--
...
--
-- Déchargement des données de la table `erp_c_prospectcontactlevel`
--
...
--
-- Structure de la table `erp_c_prospectlevel`
--
...
--
-- Déchargement des données de la table `erp_c_prospectlevel`
--
...
--
-- Structure de la table `erp_c_regions`
--
...
--
-- Déchargement des données de la table `erp_c_regions`
--
...
--
-- Structure de la table `erp_c_revenuestamp`
--
...
--
-- Déchargement des données de la table `erp_c_revenuestamp`
--
...
--
-- Structure de la table `erp_c_shipment_mode`
--
...
--
-- Déchargement des données de la table `erp_c_shipment_mode`
--

INSERT INTO `erp_c_shipment_mode` (`rowid`, `entity`, `tms`, `code`, `libelle`, `description`, `tracking`, `active`, `module`) VALUES
(1, 1, '2024-09-18 19:11:42', 'CATCH', 'In-Store Collection', 'In-store collection by the customer', '', 1, NULL),
(2, 1, '2024-09-18 19:11:42', 'TRANS', 'Generic transport service', 'Generic transport service', '', 1, NULL),
(3, 1, '2024-09-18 19:11:42', 'COLSUI', 'Colissimo Suivi', 'Colissimo Suivi', 'https://www.laposte.fr/outils/suivre-vos-envois?code={TRACKID}', 0, NULL),
(4, 1, '2024-09-18 19:11:42', 'LETTREMAX', 'Lettre Max', 'Courrier Suivi et Lettre Max', 'https://www.laposte.fr/outils/suivre-vos-envois?code={TRACKID}', 0, NULL),
(5, 1, '2024-09-18 19:11:42', 'UPS', 'UPS', 'United Parcel Service', 'http://wwwapps.ups.com/etracking/tracking.cgi?InquiryNumber2=&InquiryNumber3=&tracknums_displayed=3&loc=fr_FR&TypeOfInquiryNumber=T&HTMLVersion=4.0&InquiryNumber22=&InquiryNumber32=&track=Track&Suivi.x=64&Suivi.y=7&Suivi=Valider&InquiryNumber1={TRACKID}', 1, NULL),
(6, 1, '2024-09-18 19:11:42', 'KIALA', 'KIALA', 'Relais Kiala', 'http://www.kiala.fr/tnt/delivery/{TRACKID}', 0, NULL),
(7, 1, '2024-09-18 19:11:42', 'GLS', 'GLS', 'General Logistics Systems', 'https://gls-group.eu/FR/fr/suivi-colis?match={TRACKID}', 0, NULL),
(8, 1, '2024-09-18 19:11:42', 'CHRONO', 'Chronopost', 'Chronopost', 'http://www.chronopost.fr/expedier/inputLTNumbersNoJahia.do?listeNumeros={TRACKID}', 0, NULL),
(9, 1, '2024-09-18 19:11:42', 'INPERSON', 'In person at your site', NULL, NULL, 0, NULL),
(10, 1, '2024-09-18 19:11:42', 'FEDEX', 'Fedex', NULL, 'https://www.fedex.com/apps/fedextrack/index.html?tracknumbers={TRACKID}', 0, NULL),
(11, 1, '2024-09-18 19:11:42', 'TNT', 'TNT', NULL, 'https://www.tnt.com/express/fr_fr/site/outils-expedition/suivi.html?searchType=con&cons=={TRACKID}', 0, NULL),
(12, 1, '2024-09-18 19:11:42', 'DHL', 'DHL', NULL, 'https://www.dhl.com/fr-fr/home/tracking/tracking-global-forwarding.html?submit=1&tracking-id={TRACKID}', 0, NULL),
(13, 1, '2024-09-18 19:11:42', 'DPD', 'DPD', NULL, 'https://www.dpd.fr/trace/{TRACKID}', 0, NULL),
(14, 1, '2024-09-18 19:11:42', 'MAINFREIGHT', 'Mainfreight', NULL, 'https://www.mainfreight.com/track?{TRACKID}', 0, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `erp_c_shipment_package_type`
--
...
--
-- Structure de la table `erp_c_socialnetworks`
--
...
--
-- Déchargement des données de la table `erp_c_socialnetworks`
--
...
--
-- Structure de la table `erp_c_stcomm`
--
...
--
-- Déchargement des données de la table `erp_c_stcomm`
--

INSERT INTO `erp_c_stcomm` (`id`, `code`, `libelle`, `picto`, `sortorder`, `active`) VALUES
...
--
-- Structure de la table `erp_c_stcommcontact`
--
...
--
-- Déchargement des données de la table `erp_c_stcommcontact`
--
...
--
-- Structure de la table `erp_c_ticket_category`
--
...
--
-- Déchargement des données de la table `erp_c_ticket_category`
--
...
--
-- Structure de la table `erp_c_ticket_resolution`
--
...
--
-- Déchargement des données de la table `erp_c_ticket_resolution`
--
...
--
-- Structure de la table `erp_c_ticket_severity`
--
...
--
-- Déchargement des données de la table `erp_c_ticket_severity`
--
...
--
-- Structure de la table `erp_c_ticket_type`
--
...
--
-- Déchargement des données de la table `erp_c_ticket_type`
--
...
--
-- Structure de la table `erp_c_transport_mode`
--
...
--
-- Déchargement des données de la table `erp_c_transport_mode`
--
...
--
-- Structure de la table `erp_c_tva`
--
...
--
-- Déchargement des données de la table `erp_c_tva`
--

INSERT INTO `erp_c_tva` (`rowid`, `entity`, `fk_pays`, `code`, `taux`, `localtax1`, `localtax1_type`, `localtax2`, `localtax2_type`, `use_default`, `recuperableonly`, `note`, `active`, `accountancy_code_sell`, `accountancy_code_buy`) VALUES
...
(1025, 1, 102, '', 3, '0', '0', '0', '0', 0, 0, 'Νήσων υπερμειωμένος Φ.Π.Α.', 1, NULL, NULL),
...
--
-- Structure de la table `erp_c_typent`
--
...
--
-- Déchargement des données de la table `erp_c_typent`
--
...
--
-- Structure de la table `erp_c_type_contact`
--
...
--
-- Déchargement des données de la table `erp_c_type_contact`
--
...
--
-- Structure de la table `erp_c_type_fees`
--
...
--
-- Déchargement des données de la table `erp_c_type_fees`
--
...
--
-- Structure de la table `erp_c_type_resource`
--
...
--
-- Déchargement des données de la table `erp_c_type_resource`
--
...
--
-- Structure de la table `erp_c_units`
--
...
--
-- Déchargement des données de la table `erp_c_units`
--
...
--
-- Structure de la table `erp_c_ziptown`
--
...
--
-- Structure de la table `erp_default_values`
--
...
--
-- Structure de la table `erp_delivery`
--
...
--
-- Structure de la table `erp_deliverydet`
--
...
--
-- Structure de la table `erp_deliverydet_extrafields`
--
...
--
-- Structure de la table `erp_delivery_extrafields`
--
...
--
-- Structure de la table `erp_document_model`
--
...
--
-- Structure de la table `erp_ecm_directories`
--
...
--
-- Structure de la table `erp_ecm_directories_extrafields`
--
...
--
-- Structure de la table `erp_ecm_files`
--
...
--
-- Structure de la table `erp_ecm_files_extrafields`
--
...
--
-- Structure de la table `erp_element_categorie`
--

CREATE TABLE `erp_element_categorie` (
  `rowid` int(11) NOT NULL,
  `fk_categorie` int(11) NOT NULL,
  `fk_element` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL
...
--
-- Structure de la table `erp_element_contact`
--
...
--
-- Structure de la table `erp_element_element`
--
...
--
-- Structure de la table `erp_element_resources`
--
...
--
-- Structure de la table `erp_element_time`
--

CREATE TABLE `erp_element_time` (
  `rowid` int(11) NOT NULL,
...
--
-- Structure de la table `erp_emailcollector_emailcollector`
--
...
--
-- Structure de la table `erp_emailcollector_emailcollectoraction`
--
...
--
-- Structure de la table `erp_emailcollector_emailcollectorfilter`
--
...
--
-- Structure de la table `erp_entrepot`
--
...
--
-- Structure de la table `erp_entrepot_extrafields`
--
...
--
-- Structure de la table `erp_establishment`
--
...
--
-- Structure de la table `erp_eventorganization_conferenceorboothattendee`
--
...
--
-- Structure de la table `erp_eventorganization_conferenceorboothattendee_extrafields`
--
...
--
-- Structure de la table `erp_events`
--
...
--
-- Structure de la table `erp_event_element`
--
...
--
-- Structure de la table `erp_expedition`
--
...
--
-- Structure de la table `erp_expeditiondet`
--
...
--
-- Structure de la table `erp_expeditiondet_batch`
--
...
--
-- Structure de la table `erp_expeditiondet_extrafields`
--
...
--
-- Structure de la table `erp_expedition_extrafields`
--
...
--
-- Structure de la table `erp_expedition_package`
--
...
--
-- Structure de la table `erp_expensereport`
--
...
--
-- Structure de la table `erp_expensereport_det`
--
...
--
-- Structure de la table `erp_expensereport_extrafields`
--
...
--
-- Structure de la table `erp_export_model`
--
...
--
-- Structure de la table `erp_extrafields`
--
...
--
-- Structure de la table `erp_facture`
--
...
--
-- Structure de la table `erp_facturedet`
--
...
--
-- Structure de la table `erp_facturedet_extrafields`
--
...
--
-- Structure de la table `erp_facturedet_rec`
--
...
--
-- Structure de la table `erp_facturedet_rec_extrafields`
--
...
--
-- Structure de la table `erp_facture_extrafields`
--
...
--
-- Structure de la table `erp_facture_fourn`
--
...
--
-- Structure de la table `erp_facture_fourn_det`
--
...
--
-- Structure de la table `erp_facture_fourn_det_extrafields`
--
...
--
-- Structure de la table `erp_facture_fourn_det_rec`
--

CREATE TABLE `erp_facture_fourn_det_rec` (
  `rowid` int(11) NOT NULL,
  `fk_facture_fourn` int(11) NOT NULL,
  `fk_parent_line` int(11) DEFAULT NULL,
  `fk_product` int(11) DEFAULT NULL,
...
--
-- Structure de la table `erp_facture_fourn_det_rec_extrafields`
--

CREATE TABLE `erp_facture_fourn_det_rec_extrafields` (
  `rowid` int(11) NOT NULL,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL
...
--
-- Structure de la table `erp_facture_fourn_extrafields`
--
...
--
-- Structure de la table `erp_facture_fourn_rec`
--

CREATE TABLE `erp_facture_fourn_rec` (
  `rowid` int(11) NOT NULL,
...
--
-- Structure de la table `erp_facture_fourn_rec_extrafields`
--

CREATE TABLE `erp_facture_fourn_rec_extrafields` (
  `rowid` int(11) NOT NULL,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL
...
--
-- Structure de la table `erp_facture_rec`
--
...
--
-- Structure de la table `erp_facture_rec_extrafields`
--
...
--
-- Structure de la table `erp_fichinter`
--
...
--
-- Structure de la table `erp_fichinterdet`
--
...
--
-- Structure de la table `erp_fichinterdet_extrafields`
--
...
--
-- Structure de la table `erp_fichinterdet_rec`
--
...
--
-- Structure de la table `erp_fichinter_extrafields`
--
...
--
-- Structure de la table `erp_fichinter_rec`
--
...
--
-- Structure de la table `erp_holiday`
--
...
--
-- Structure de la table `erp_holiday_config`
--
...
--
-- Déchargement des données de la table `erp_holiday_config`
--
...
--
-- Structure de la table `erp_holiday_extrafields`
--
...
--
-- Structure de la table `erp_holiday_logs`
--
...
--
-- Structure de la table `erp_holiday_users`
--
...
--
-- Structure de la table `erp_import_model`
--
...
--
-- Structure de la table `erp_links`
--
...
--
-- Structure de la table `erp_localtax`
--
...
--
-- Structure de la table `erp_mailing_unsubscribe`
--
...
--
-- Structure de la table `erp_menu`
--
...
--
-- Structure de la table `erp_mrp_mo`
--
...
--
-- Structure de la table `erp_mrp_mo_extrafields`
--
...
--
-- Structure de la table `erp_mrp_production`
--
...
--
-- Structure de la table `erp_mrp_production_extrafields`
--

CREATE TABLE `erp_mrp_production_extrafields` (
  `rowid` int(11) NOT NULL,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL
...
--
-- Structure de la table `erp_multicurrency`
--
...
--
-- Structure de la table `erp_multicurrency_rate`
--
...
--
-- Structure de la table `erp_notify`
--
...
--
-- Structure de la table `erp_notify_def`
--
...
--
-- Structure de la table `erp_notify_def_object`
--
...
--
-- Structure de la table `erp_oauth_state`
--
...
--
-- Structure de la table `erp_oauth_token`
--
...
--
-- Structure de la table `erp_object_lang`
--
...
--
-- Structure de la table `erp_onlinesignature`
--
...
--
-- Structure de la table `erp_overwrite_trans`
--
...
--
-- Structure de la table `erp_paiement`
--
...
--
-- Structure de la table `erp_paiementcharge`
--
...
--
-- Structure de la table `erp_paiementfourn`
--
...
--
-- Structure de la table `erp_paiementfourn_facturefourn`
--
...
--
-- Structure de la table `erp_paiement_facture`
--
...
--
-- Structure de la table `erp_payment_donation`
--
...
--
-- Structure de la table `erp_payment_expensereport`
--
...
--
-- Structure de la table `erp_payment_loan`
--
...
--
-- Structure de la table `erp_payment_salary`
--
...
--
-- Structure de la table `erp_payment_various`
--
...
--
-- Structure de la table `erp_payment_vat`
--
...
--
-- Structure de la table `erp_pos_cash_fence`
--
...
--
-- Structure de la table `erp_prelevement`
--

CREATE TABLE `erp_prelevement` (
  `rowid` int(11) NOT NULL,
  `fk_facture` int(11) DEFAULT NULL,
...
--
-- Structure de la table `erp_prelevement_bons`
--
...
--
-- Structure de la table `erp_prelevement_demande`
--

CREATE TABLE `erp_prelevement_demande` (
  `rowid` int(11) NOT NULL,
  `entity` int(11) NOT NULL DEFAULT 1,
  `fk_facture` int(11) DEFAULT NULL,
  `fk_facture_fourn` int(11) DEFAULT NULL,
...
--
-- Structure de la table `erp_prelevement_lignes`
--
...
--
-- Structure de la table `erp_prelevement_rejet`
--
...
--
-- Structure de la table `erp_printing`
--
...
--
-- Structure de la table `erp_product`
--
...
--
-- Structure de la table `erp_product_association`
--
...
--
-- Structure de la table `erp_product_attribute`
--
...
--
-- Structure de la table `erp_product_attribute_combination`
--
...
--
-- Structure de la table `erp_product_attribute_combination2val`
--
...
--
-- Structure de la table `erp_product_attribute_combination_price_level`
--
...
--
-- Structure de la table `erp_product_attribute_value`
--
...
--
-- Structure de la table `erp_product_batch`
--
...
--
-- Structure de la table `erp_product_customer_price`
--
...
--
-- Structure de la table `erp_product_customer_price_log`
--
...
--
-- Structure de la table `erp_product_extrafields`
--
...
--
-- Structure de la table `erp_product_fournisseur_price`
--
...
--
-- Structure de la table `erp_product_fournisseur_price_extrafields`
--
...
--
-- Structure de la table `erp_product_fournisseur_price_log`
--
...
--
-- Structure de la table `erp_product_lang`
--
...
--
-- Structure de la table `erp_product_lot`
--
...
--
-- Structure de la table `erp_product_lot_extrafields`
--
...
--
-- Structure de la table `erp_product_price`
--
...
--
-- Structure de la table `erp_product_pricerules`
--
...
--
-- Structure de la table `erp_product_price_by_qty`
--
...
--
-- Structure de la table `erp_product_stock`
--
...
--
-- Structure de la table `erp_product_warehouse_properties`
--
...
--
-- Structure de la table `erp_projet`
--
...
--
-- Structure de la table `erp_projet_extrafields`
--
...
--
-- Structure de la table `erp_projet_task`
--
...
--
-- Structure de la table `erp_projet_task_extrafields`
--
...
--
-- Structure de la table `erp_propal`
--
...
--
-- Structure de la table `erp_propaldet`
--
...
--
-- Structure de la table `erp_propaldet_extrafields`
--
...
--
-- Structure de la table `erp_propal_extrafields`
--
...
--
-- Structure de la table `erp_propal_merge_pdf_product`
--
...
--
-- Structure de la table `erp_reception`
--
...
--
-- Structure de la table `erp_reception_extrafields`
--
...
--
-- Structure de la table `erp_resource`
--
...
--
-- Structure de la table `erp_resource_extrafields`
--
...
--
-- Structure de la table `erp_rights_def`
--
...
--
-- Déchargement des données de la table `erp_rights_def`
--
...
--
-- Structure de la table `erp_salary`
--
...
--
-- Structure de la table `erp_salary_extrafields`
--
...
--
-- Structure de la table `erp_societe`
--
...
--
-- Structure de la table `erp_societe_account`
--
...
--
-- Structure de la table `erp_societe_commerciaux`
--
...
--
-- Structure de la table `erp_societe_contacts`
--
...
--
-- Structure de la table `erp_societe_extrafields`
--
...
--
-- Structure de la table `erp_societe_prices`
--
...
--
-- Structure de la table `erp_societe_remise`
--
...
--
-- Structure de la table `erp_societe_remise_except`
--
...
--
-- Structure de la table `erp_societe_remise_supplier`
--
...
--
-- Structure de la table `erp_societe_rib`
--
...
--
-- Structure de la table `erp_socpeople`
--
...
--
-- Structure de la table `erp_socpeople_extrafields`
--
...
--
-- Structure de la table `erp_stock_mouvement`
--
...
--
-- Structure de la table `erp_stock_mouvement_extrafields`
--

CREATE TABLE `erp_stock_mouvement_extrafields` (
  `rowid` int(11) NOT NULL,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL
...
--
-- Structure de la table `erp_subscription`
--
...
--
-- Structure de la table `erp_supplier_proposal`
--
...
--
-- Structure de la table `erp_supplier_proposaldet`
--
...
--
-- Structure de la table `erp_supplier_proposaldet_extrafields`
--
...
--
-- Structure de la table `erp_supplier_proposal_extrafields`
--
...
--
-- Structure de la table `erp_user`
--
...
--
-- Déchargement des données de la table `erp_user`
--

INSERT INTO `erp_user` (`rowid`, `entity`, `ref_employee`, `ref_ext`, `admin`, `employee`, `fk_establishment`, `datec`, `tms`, `fk_user_creat`, `fk_user_modif`, `login`, `pass_encoding`, `pass`, `pass_crypted`, `pass_temp`, `api_key`, `gender`, `civility`, `lastname`, `firstname`, `address`, `zip`, `town`, `fk_state`, `fk_country`, `birth`, `birth_place`, `job`, `office_phone`, `office_fax`, `user_mobile`, `personal_mobile`, `email`, `personal_email`, `email_oauth2`, `signature`, `socialnetworks`, `fk_soc`, `fk_socpeople`, `fk_member`, `fk_user`, `fk_user_expense_validator`, `fk_user_holiday_validator`, `idpers1`, `idpers2`, `idpers3`, `note_public`, `note_private`, `model_pdf`, `last_main_doc`, `datelastlogin`, `datepreviouslogin`, `datelastpassvalidation`, `datestartvalidity`, `dateendvalidity`, `flagdelsessionsbefore`, `iplastlogin`, `ippreviouslogin`, `egroupware_id`, `ldap_sid`, `openid`, `statut`, `photo`, `lang`, `color`, `barcode`, `fk_barcode_type`, `accountancy_code`, `nb_holiday`, `thm`, `tjm`, `salary`, `salaryextra`, `dateemployment`, `dateemploymentend`, `weeklyhours`, `import_key`, `default_range`, `default_c_exp_tax_cat`, `national_registration_number`, `fk_warehouse`) VALUES
(1, 0, '', NULL, 1, 1, 0, '2024-09-18 19:11:42', '2024-09-18 19:11:42', NULL, NULL, 'admin', NULL, NULL, '$2y$10$pghMdvFFsfi76y8dMK6cMOLYn3G1adOcobeb4jMlC5QEhJjOlrrlu', NULL, NULL, '', '', 'SuperAdmin', '', '', '', '', NULL, NULL, NULL, NULL, '', '', '', '', '', '', '', NULL, '', 'null', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '2024-09-18 20:23:05', '2024-09-18 20:16:13', NULL, NULL, NULL, NULL, '102.17.61.64', '41.74.208.220', NULL, '', NULL, 1, NULL, NULL, '', NULL, 0, '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `erp_usergroup`
--
...
--
-- Structure de la table `erp_usergroup_extrafields`
--
...
--
-- Structure de la table `erp_usergroup_rights`
--
...
--
-- Structure de la table `erp_usergroup_user`
--
...
--
-- Structure de la table `erp_user_alert`
--
...
--
-- Structure de la table `erp_user_clicktodial`
--
...
--
-- Structure de la table `erp_user_employment`
--
...
--
-- Structure de la table `erp_user_extrafields`
--
...
--
-- Structure de la table `erp_user_param`
--
...
--
-- Structure de la table `erp_user_rib`
--
...
--
-- Structure de la table `erp_user_rights`
--
...
--
-- Déchargement des données de la table `erp_user_rights`
--
...
--
/*
-- Index pour la table `erp_accounting_account`
--
...
--
-- Index pour la table `erp_accounting_bookkeeping`
--
...
--
-- Index pour la table `erp_accounting_bookkeeping_tmp`
--
...
--
-- Index pour la table `erp_accounting_fiscalyear`
--
ALTER TABLE `erp_accounting_fiscalyear`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_accounting_groups_account`
--
ALTER TABLE `erp_accounting_groups_account`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_accounting_journal`
--
...
--
-- Index pour la table `erp_accounting_system`
--
...
--
-- Index pour la table `erp_actioncomm`
--
...
--
-- Index pour la table `erp_actioncomm_extrafields`
--
...
--
-- Index pour la table `erp_actioncomm_reminder`
--
...
--
-- Index pour la table `erp_actioncomm_resources`
--
...
--
-- Index pour la table `erp_adherent`
--
...
--
-- Index pour la table `erp_adherent_extrafields`
--
...
--
-- Index pour la table `erp_adherent_type`
--
...
--
-- Index pour la table `erp_adherent_type_extrafields`
--
...
--
-- Index pour la table `erp_adherent_type_lang`
--
ALTER TABLE `erp_adherent_type_lang`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_bank`
--
...
--
-- Index pour la table `erp_bank_account`
--
...
--
-- Index pour la table `erp_bank_account_extrafields`
--
...
--
-- Index pour la table `erp_bank_categ`
--
ALTER TABLE `erp_bank_categ`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_bank_class`
--
ALTER TABLE `erp_bank_class`
  ADD UNIQUE KEY `uk_bank_class_lineid` (`lineid`,`fk_categ`);

--
-- Index pour la table `erp_bank_extrafields`
--
ALTER TABLE `erp_bank_extrafields`
  ADD PRIMARY KEY (`rowid`),
  ADD KEY `idx_bank_extrafields` (`fk_object`);

--
-- Index pour la table `erp_bank_url`
--
...
--
-- Index pour la table `erp_blockedlog`
--
...
--
-- Index pour la table `erp_blockedlog_authority`
--
...
--
-- Index pour la table `erp_bom_bom`
--
...
--
-- Index pour la table `erp_bom_bomline`
--
...
--
-- Index pour la table `erp_bom_bomline_extrafields`
--
ALTER TABLE `erp_bom_bomline_extrafields`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_bom_bom_extrafields`
--
...
--
-- Index pour la table `erp_bookmark`
--
...
--
-- Index pour la table `erp_bordereau_cheque`
--
...
--
-- Index pour la table `erp_boxes_def`
--
...
--
-- Index pour la table `erp_categorie`
--
ALTER TABLE `erp_categorie`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_categories_extrafields`
--
...
--
-- Index pour la table `erp_categorie_account`
--
...
--
-- Index pour la table `erp_categorie_actioncomm`
--
...
--
-- Index pour la table `erp_categorie_contact`
--
...
--
-- Index pour la table `erp_categorie_fournisseur`
--
...
--
-- Index pour la table `erp_categorie_lang`
--
...
--
-- Index pour la table `erp_categorie_member`
--
...
--
-- Index pour la table `erp_categorie_product`
--
...
--
-- Index pour la table `erp_categorie_project`
--
...
--
-- Index pour la table `erp_categorie_societe`
--
...
--
-- Index pour la table `erp_categorie_user`
--
...
--
-- Index pour la table `erp_categorie_warehouse`
--
...
--
-- Index pour la table `erp_chargesociales`
--
ALTER TABLE `erp_chargesociales`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_commande`
--
...
--
-- Index pour la table `erp_commandedet`
--
...
--
-- Index pour la table `erp_commandedet_extrafields`
--
...
--
-- Index pour la table `erp_commande_extrafields`
--
...
--
-- Index pour la table `erp_commande_fournisseur`
--
...
--
-- Index pour la table `erp_commande_fournisseurdet`
--
...
--
-- Index pour la table `erp_commande_fournisseurdet_extrafields`
--
...
--
-- Index pour la table `erp_commande_fournisseur_dispatch`
--
ALTER TABLE `erp_commande_fournisseur_dispatch`
  ...
  ADD KEY `idx_commande_fournisseur_dispatch_fk_commandefourndet` (`fk_commandefourndet`);

--
-- Index pour la table `erp_commande_fournisseur_dispatch_extrafields`
--
...
--
-- Index pour la table `erp_commande_fournisseur_extrafields`
--
...
--
-- Index pour la table `erp_commande_fournisseur_log`
--
ALTER TABLE `erp_commande_fournisseur_log`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_comment`
--
ALTER TABLE `erp_comment`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_const`
--
...
--
-- Index pour la table `erp_contrat`
--
...
--
-- Index pour la table `erp_contratdet`
--
...
--
-- Index pour la table `erp_contratdet_extrafields`
--
...
--
-- Index pour la table `erp_contratdet_log`
--
...
--
-- Index pour la table `erp_contrat_extrafields`
--
...
--
-- Index pour la table `erp_cronjob`
--
...
--
-- Index pour la table `erp_c_accounting_category`
--
...
--
-- Index pour la table `erp_c_actioncomm`
--
...
--
-- Index pour la table `erp_c_action_trigger`
--
...
--
-- Index pour la table `erp_c_availability`
--
...
--
-- Index pour la table `erp_c_barcode_type`
--
...
--
-- Index pour la table `erp_c_chargesociales`
--
ALTER TABLE `erp_c_chargesociales`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `erp_c_civility`
--
...
--
-- Index pour la table `erp_c_country`
--
...
--
-- Index pour la table `erp_c_currencies`
--
...
--
-- Index pour la table `erp_c_departements`
--
...
--
-- Index pour la table `erp_c_ecotaxe`
--
...
--
-- Index pour la table `erp_c_effectif`
--
...
--
-- Index pour la table `erp_c_email_senderprofile`
--
...
--
-- Index pour la table `erp_c_email_templates`
--
...
--
-- Index pour la table `erp_c_field_list`
--
ALTER TABLE `erp_c_field_list`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_c_format_cards`
--
ALTER TABLE `erp_c_format_cards`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_c_forme_juridique`
--
...
--
-- Index pour la table `erp_c_holiday_types`
--
...
--
-- Index pour la table `erp_c_hrm_department`
--
ALTER TABLE `erp_c_hrm_department`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_c_hrm_function`
--
ALTER TABLE `erp_c_hrm_function`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_c_hrm_public_holiday`
--
...
--
-- Index pour la table `erp_c_incoterms`
--
...
--
-- Index pour la table `erp_c_input_method`
--
...
--
-- Index pour la table `erp_c_input_reason`
--
...
--
-- Index pour la table `erp_c_invoice_subtype`
--
ALTER TABLE `erp_c_invoice_subtype`
  ADD PRIMARY KEY (`rowid`),
  ADD UNIQUE KEY `uk_c_invoice_subtype` (`entity`,`code`,`fk_country`);

--
-- Index pour la table `erp_c_lead_status`
--
...
--
-- Index pour la table `erp_c_paiement`
--
...
--
-- Index pour la table `erp_c_paper_format`
--
ALTER TABLE `erp_c_paper_format`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_c_payment_term`
--
...
--
-- Index pour la table `erp_c_productbatch_qcstatus`
--
...
--
-- Index pour la table `erp_c_product_nature`
--
...
--
-- Index pour la table `erp_c_propalst`
--
...
--
-- Index pour la table `erp_c_prospectcontactlevel`
--
ALTER TABLE `erp_c_prospectcontactlevel`
  ADD PRIMARY KEY (`code`);

--
-- Index pour la table `erp_c_prospectlevel`
--
ALTER TABLE `erp_c_prospectlevel`
  ADD PRIMARY KEY (`code`);

--
-- Index pour la table `erp_c_regions`
--
...
--
-- Index pour la table `erp_c_revenuestamp`
--
ALTER TABLE `erp_c_revenuestamp`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_c_shipment_mode`
--
...
--
-- Index pour la table `erp_c_shipment_package_type`
--
ALTER TABLE `erp_c_shipment_package_type`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_c_socialnetworks`
--
...
--
-- Index pour la table `erp_c_stcomm`
--
...
--
-- Index pour la table `erp_c_stcommcontact`
--
...
--
-- Index pour la table `erp_c_ticket_category`
--
...
--
-- Index pour la table `erp_c_ticket_resolution`
--
...
--
-- Index pour la table `erp_c_ticket_severity`
--
...
--
-- Index pour la table `erp_c_ticket_type`
--
...
--
-- Index pour la table `erp_c_transport_mode`
--
...
--
-- Index pour la table `erp_c_typent`
--
...
--
-- Index pour la table `erp_c_type_contact`
--
...
--
-- Index pour la table `erp_c_type_fees`
--
...
--
-- Index pour la table `erp_c_type_resource`
--
...
--
-- Index pour la table `erp_c_units`
--
...
--
-- Index pour la table `erp_c_ziptown`
--
...
--
-- Index pour la table `erp_default_values`
--
...
--
-- Index pour la table `erp_delivery`
--
...
--
-- Index pour la table `erp_deliverydet`
--
...
--
-- Index pour la table `erp_deliverydet_extrafields`
--
...
--
-- Index pour la table `erp_delivery_extrafields`
--
...
--
-- Index pour la table `erp_document_model`
--
...
--
-- Index pour la table `erp_ecm_directories`
--
...
--
-- Index pour la table `erp_ecm_directories_extrafields`
--
...
--
-- Index pour la table `erp_ecm_files`
--
...
--
-- Index pour la table `erp_ecm_files_extrafields`
--
...
--
-- Index pour la table `erp_element_element`
--
...
--
-- Index pour la table `erp_element_resources`
--
...
--
-- Index pour la table `erp_element_time`
--
ALTER TABLE `erp_element_time`
  ADD PRIMARY KEY (`rowid`),
...
--
-- Index pour la table `erp_emailcollector_emailcollector`
--
...
--
-- Index pour la table `erp_emailcollector_emailcollectoraction`
--
...
--
-- Index pour la table `erp_emailcollector_emailcollectorfilter`
--
...
--
-- Index pour la table `erp_entrepot`
--
...
--
-- Index pour la table `erp_entrepot_extrafields`
--
...
--
-- Index pour la table `erp_establishment`
--
ALTER TABLE `erp_establishment`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_eventorganization_conferenceorboothattendee`
--
...
--
-- Index pour la table `erp_eventorganization_conferenceorboothattendee_extrafields`
--
...
--
-- Index pour la table `erp_events`
--
...
--
-- Index pour la table `erp_event_element`
--
ALTER TABLE `erp_event_element`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_expedition`
--
...
--
-- Index pour la table `erp_expeditiondet`
--
...
--
-- Index pour la table `erp_expeditiondet_batch`
--
...
--
-- Index pour la table `erp_expeditiondet_extrafields`
--
...
--
-- Index pour la table `erp_expedition_extrafields`
--
...
--
-- Index pour la table `erp_expedition_package`
--
ALTER TABLE `erp_expedition_package`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_expensereport`
--
...
--
-- Index pour la table `erp_expensereport_det`
--
ALTER TABLE `erp_expensereport_det`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_expensereport_extrafields`
--
...
--
-- Index pour la table `erp_export_model`
--
...
--
-- Index pour la table `erp_extrafields`
--
...
--
-- Index pour la table `erp_facture`
--
...
--
-- Index pour la table `erp_facturedet`
--
...
--
-- Index pour la table `erp_facturedet_extrafields`
--
...
--
-- Index pour la table `erp_facturedet_rec`
--
...
--
-- Index pour la table `erp_facturedet_rec_extrafields`
--
...
--
-- Index pour la table `erp_facture_extrafields`
--
...
--
-- Index pour la table `erp_facture_fourn`
--
...
--
-- Index pour la table `erp_facture_fourn_det`
--
...
--
-- Index pour la table `erp_facture_fourn_det_extrafields`
--
...
--
-- Index pour la table `erp_facture_fourn_det_rec`
--
ALTER TABLE `erp_facture_fourn_det_rec`
  ADD PRIMARY KEY (`rowid`),
  ADD KEY `fk_facture_fourn_det_rec_fk_unit` (`fk_unit`);

--
-- Index pour la table `erp_facture_fourn_det_rec_extrafields`
--
ALTER TABLE `erp_facture_fourn_det_rec_extrafields`
  ADD PRIMARY KEY (`rowid`),
  ADD KEY `erp_facture_fourn_det_rec_extrafields` (`fk_object`);

--
-- Index pour la table `erp_facture_fourn_extrafields`
--
...
--
-- Index pour la table `erp_facture_fourn_rec`
--
ALTER TABLE `erp_facture_fourn_rec`
  ADD PRIMARY KEY (`rowid`),
...
--
-- Index pour la table `erp_facture_fourn_rec_extrafields`
--
ALTER TABLE `erp_facture_fourn_rec_extrafields`
  ADD PRIMARY KEY (`rowid`),
  ADD KEY `idx_facture_fourn_rec_extrafields` (`fk_object`);

--
-- Index pour la table `erp_facture_rec`
--
...
--
-- Index pour la table `erp_facture_rec_extrafields`
--
...
--
-- Index pour la table `erp_fichinter`
--
...
--
-- Index pour la table `erp_fichinterdet`
--
...
--
-- Index pour la table `erp_fichinterdet_extrafields`
--
...
--
-- Index pour la table `erp_fichinterdet_rec`
--
ALTER TABLE `erp_fichinterdet_rec`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_fichinter_extrafields`
--
...
--
-- Index pour la table `erp_fichinter_rec`
--
...
--
-- Index pour la table `erp_holiday`
--
...
--
-- Index pour la table `erp_holiday_config`
--
...
--
-- Index pour la table `erp_holiday_extrafields`
--
...
--
-- Index pour la table `erp_holiday_logs`
--
ALTER TABLE `erp_holiday_logs`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_holiday_users`
--
ALTER TABLE `erp_holiday_users`
  ADD UNIQUE KEY `uk_holiday_users` (`fk_user`,`fk_type`);

--
-- Index pour la table `erp_import_model`
--
...
--
-- Index pour la table `erp_localtax`
--
ALTER TABLE `erp_localtax`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_mailing_unsubscribe`
--
...
--
-- Index pour la table `erp_mrp_mo`
--
...
--
-- Index pour la table `erp_mrp_mo_extrafields`
--
...
--
-- Index pour la table `erp_mrp_production`
--
...
--
-- Index pour la table `erp_mrp_production_extrafields`
--
ALTER TABLE `erp_mrp_production_extrafields`
  ADD PRIMARY KEY (`rowid`),
  ADD KEY `idx_mrp_production_fk_object` (`fk_object`);

--
-- Index pour la table `erp_multicurrency`
--
ALTER TABLE `erp_multicurrency`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_multicurrency_rate`
--
ALTER TABLE `erp_multicurrency_rate`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_notify`
--
ALTER TABLE `erp_notify`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_notify_def`
--
ALTER TABLE `erp_notify_def`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_notify_def_object`
--
ALTER TABLE `erp_notify_def_object`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `erp_oauth_state`
--
ALTER TABLE `erp_oauth_state`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_oauth_token`
--
ALTER TABLE `erp_oauth_token`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_object_lang`
--
...
--
-- Index pour la table `erp_onlinesignature`
--
ALTER TABLE `erp_onlinesignature`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_overwrite_trans`
--
...
--
-- Index pour la table `erp_paiement`
--
ALTER TABLE `erp_paiement`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_paiementcharge`
--
ALTER TABLE `erp_paiementcharge`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_paiementfourn`
--
ALTER TABLE `erp_paiementfourn`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_paiementfourn_facturefourn`
--
...
--
-- Index pour la table `erp_paiement_facture`
--
...
--
-- Index pour la table `erp_payment_donation`
--
ALTER TABLE `erp_payment_donation`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_payment_expensereport`
--
ALTER TABLE `erp_payment_expensereport`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_payment_loan`
--
ALTER TABLE `erp_payment_loan`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_payment_salary`
--
...
--
-- Index pour la table `erp_payment_various`
--
ALTER TABLE `erp_payment_various`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_payment_vat`
--
ALTER TABLE `erp_payment_vat`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_pos_cash_fence`
--
ALTER TABLE `erp_pos_cash_fence`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_prelevement`
--
ALTER TABLE `erp_prelevement`
  ADD PRIMARY KEY (`rowid`),
  ADD KEY `idx_prelevement_fk_prelevement_lignes` (`fk_prelevement_lignes`);

--
-- Index pour la table `erp_prelevement_bons`
--
...
--
-- Index pour la table `erp_prelevement_demande`
--
ALTER TABLE `erp_prelevement_demande`
  ADD PRIMARY KEY (`rowid`),
...
--
-- Index pour la table `erp_prelevement_lignes`
--
...
--
-- Index pour la table `erp_prelevement_rejet`
--
ALTER TABLE `erp_prelevement_rejet`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_printing`
--
ALTER TABLE `erp_printing`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_product`
--
...
--
-- Index pour la table `erp_product_association`
--
...
--
-- Index pour la table `erp_product_attribute`
--
...
--
-- Index pour la table `erp_product_attribute_combination`
--
...
--
-- Index pour la table `erp_product_attribute_combination2val`
--
ALTER TABLE `erp_product_attribute_combination2val`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_product_attribute_combination_price_level`
--
...
--
-- Index pour la table `erp_product_attribute_value`
--
...
--
-- Index pour la table `erp_product_batch`
--
...
--
-- Index pour la table `erp_product_customer_price`
--
...
--
-- Index pour la table `erp_product_customer_price_log`
--
ALTER TABLE `erp_product_customer_price_log`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_product_extrafields`
--
...
--
-- Index pour la table `erp_product_fournisseur_price`
--
...
--
-- Index pour la table `erp_product_fournisseur_price_extrafields`
--
...
--
-- Index pour la table `erp_product_fournisseur_price_log`
--
...
--
-- Index pour la table `erp_product_lang`
--
...
--
-- Index pour la table `erp_product_lot`
--
...
--
-- Index pour la table `erp_product_lot_extrafields`
--
...
--
-- Index pour la table `erp_product_price`
--
...
--
-- Index pour la table `erp_product_pricerules`
--
...
--
-- Index pour la table `erp_product_price_by_qty`
--
...
--
-- Index pour la table `erp_product_stock`
--
...
--
-- Index pour la table `erp_product_warehouse_properties`
--
ALTER TABLE `erp_product_warehouse_properties`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_projet`
--
...
--
-- Index pour la table `erp_projet_extrafields`
--
...
--
-- Index pour la table `erp_projet_task`
--
...
--
-- Index pour la table `erp_projet_task_extrafields`
--
...
--
-- Index pour la table `erp_propal`
--
...
--
-- Index pour la table `erp_propaldet`
--
...
--
-- Index pour la table `erp_propaldet_extrafields`
--
...
--
-- Index pour la table `erp_propal_extrafields`
--
...
--
-- Index pour la table `erp_propal_merge_pdf_product`
--
ALTER TABLE `erp_propal_merge_pdf_product`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_reception`
--
...
--
-- Index pour la table `erp_reception_extrafields`
--
...
--
-- Index pour la table `erp_resource`
--
...
--
-- Index pour la table `erp_resource_extrafields`
--
...
--
-- Index pour la table `erp_rights_def`
--
ALTER TABLE `erp_rights_def`
  ADD PRIMARY KEY (`id`,`entity`);

--
-- Index pour la table `erp_salary`
--
ALTER TABLE `erp_salary`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_salary_extrafields`
--
...
--
-- Index pour la table `erp_societe`
--
...
--
-- Index pour la table `erp_societe_account`
--
...
--
-- Index pour la table `erp_societe_commerciaux`
--
...
--
-- Index pour la table `erp_societe_contacts`
--
...
--
-- Index pour la table `erp_societe_extrafields`
--
...
--
-- Index pour la table `erp_societe_prices`
--
ALTER TABLE `erp_societe_prices`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_societe_remise`
--
ALTER TABLE `erp_societe_remise`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_societe_remise_except`
--
...
--
-- Index pour la table `erp_societe_remise_supplier`
--
ALTER TABLE `erp_societe_remise_supplier`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_societe_rib`
--
...
--
-- Index pour la table `erp_socpeople`
--
...
--
-- Index pour la table `erp_socpeople_extrafields`
--
...
--
-- Index pour la table `erp_stock_mouvement`
--
...
--
-- Index pour la table `erp_stock_mouvement_extrafields`
--
ALTER TABLE `erp_stock_mouvement_extrafields`
  ADD PRIMARY KEY (`rowid`),
  ADD KEY `idx_stock_mouvement_extrafields` (`fk_object`);

--
-- Index pour la table `erp_subscription`
--
...
--
-- Index pour la table `erp_supplier_proposal`
--
...
--
-- Index pour la table `erp_supplier_proposaldet`
--
...
--
-- Index pour la table `erp_supplier_proposaldet_extrafields`
--
...
--
-- Index pour la table `erp_supplier_proposal_extrafields`
--
...
--
-- Index pour la table `erp_tva`
--
ALTER TABLE `erp_tva`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_user`
--
...
--
-- Index pour la table `erp_usergroup`
--
...
--
-- Index pour la table `erp_usergroup_extrafields`
--
...
--
-- Index pour la table `erp_usergroup_rights`
--
...
--
-- Index pour la table `erp_usergroup_user`
--
...
--
-- Index pour la table `erp_user_alert`
--
ALTER TABLE `erp_user_alert`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_user_clicktodial`
--
ALTER TABLE `erp_user_clicktodial`
  ADD PRIMARY KEY (`fk_user`);

--
-- Index pour la table `erp_user_employment`
--
...
--
-- Index pour la table `erp_user_extrafields`
--
...
--
-- Index pour la table `erp_user_param`
--
ALTER TABLE `erp_user_param`
  ADD UNIQUE KEY `uk_user_param` (`fk_user`,`param`,`entity`);

--
-- Index pour la table `erp_user_rib`
--
ALTER TABLE `erp_user_rib`
  ADD PRIMARY KEY (`rowid`);

--
-- Index pour la table `erp_user_rights`
--
...
--
-- AUTO_INCREMENT pour la table `erp_accounting_account`
--
ALTER TABLE `erp_accounting_account`
  MODIFY `rowid` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_accounting_bookkeeping`
--
ALTER TABLE `erp_accounting_bookkeeping`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_accounting_bookkeeping_tmp`
--
ALTER TABLE `erp_accounting_bookkeeping_tmp`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_accounting_fiscalyear`
--
ALTER TABLE `erp_accounting_fiscalyear`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_accounting_groups_account`
--
ALTER TABLE `erp_accounting_groups_account`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_accounting_journal`
--
ALTER TABLE `erp_accounting_journal`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `erp_accounting_system`
--
ALTER TABLE `erp_accounting_system`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT pour la table `erp_actioncomm`
--
ALTER TABLE `erp_actioncomm`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_actioncomm_extrafields`
--
ALTER TABLE `erp_actioncomm_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_actioncomm_reminder`
--
ALTER TABLE `erp_actioncomm_reminder`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_actioncomm_resources`
--
ALTER TABLE `erp_actioncomm_resources`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_adherent`
--
ALTER TABLE `erp_adherent`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_adherent_extrafields`
--
ALTER TABLE `erp_adherent_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_adherent_type`
--
ALTER TABLE `erp_adherent_type`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_adherent_type_extrafields`
--
ALTER TABLE `erp_adherent_type_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_adherent_type_lang`
--
ALTER TABLE `erp_adherent_type_lang`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bank`
--
ALTER TABLE `erp_bank`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bank_account`
--
ALTER TABLE `erp_bank_account`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bank_account_extrafields`
--
ALTER TABLE `erp_bank_account_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bank_categ`
--
ALTER TABLE `erp_bank_categ`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bank_extrafields`
--
ALTER TABLE `erp_bank_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bank_url`
--
ALTER TABLE `erp_bank_url`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_blockedlog`
--
ALTER TABLE `erp_blockedlog`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_blockedlog_authority`
--
ALTER TABLE `erp_blockedlog_authority`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bom_bom`
--
ALTER TABLE `erp_bom_bom`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bom_bomline`
--
ALTER TABLE `erp_bom_bomline`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bom_bomline_extrafields`
--
ALTER TABLE `erp_bom_bomline_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bom_bom_extrafields`
--
ALTER TABLE `erp_bom_bom_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bookmark`
--
ALTER TABLE `erp_bookmark`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_bordereau_cheque`
--
ALTER TABLE `erp_bordereau_cheque`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_boxes`
--
ALTER TABLE `erp_boxes`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `erp_boxes_def`
--
ALTER TABLE `erp_boxes_def`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `erp_categorie`
--
ALTER TABLE `erp_categorie`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_categories_extrafields`
--
ALTER TABLE `erp_categories_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_categorie_lang`
--
ALTER TABLE `erp_categorie_lang`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_chargesociales`
--
ALTER TABLE `erp_chargesociales`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commande`
--
ALTER TABLE `erp_commande`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commandedet`
--
ALTER TABLE `erp_commandedet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commandedet_extrafields`
--
ALTER TABLE `erp_commandedet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commande_extrafields`
--
ALTER TABLE `erp_commande_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commande_fournisseur`
--
ALTER TABLE `erp_commande_fournisseur`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commande_fournisseurdet`
--
ALTER TABLE `erp_commande_fournisseurdet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commande_fournisseurdet_extrafields`
--
ALTER TABLE `erp_commande_fournisseurdet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commande_fournisseur_dispatch`
--
ALTER TABLE `erp_commande_fournisseur_dispatch`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commande_fournisseur_dispatch_extrafields`
--
ALTER TABLE `erp_commande_fournisseur_dispatch_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commande_fournisseur_extrafields`
--
ALTER TABLE `erp_commande_fournisseur_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_commande_fournisseur_log`
--
ALTER TABLE `erp_commande_fournisseur_log`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_comment`
--
ALTER TABLE `erp_comment`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_const`
--
ALTER TABLE `erp_const`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT pour la table `erp_contrat`
--
ALTER TABLE `erp_contrat`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_contratdet`
--
ALTER TABLE `erp_contratdet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_contratdet_extrafields`
--
ALTER TABLE `erp_contratdet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_contratdet_log`
--
ALTER TABLE `erp_contratdet_log`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_contrat_extrafields`
--
ALTER TABLE `erp_contrat_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_cronjob`
--
ALTER TABLE `erp_cronjob`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_c_accounting_category`
--
ALTER TABLE `erp_c_accounting_category`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `erp_c_action_trigger`
--
ALTER TABLE `erp_c_action_trigger`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;

--
-- AUTO_INCREMENT pour la table `erp_c_availability`
--
ALTER TABLE `erp_c_availability`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT pour la table `erp_c_barcode_type`
--
ALTER TABLE `erp_c_barcode_type`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_c_chargesociales`
--
ALTER TABLE `erp_c_chargesociales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10214;

--
-- AUTO_INCREMENT pour la table `erp_c_civility`
--
ALTER TABLE `erp_c_civility`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `erp_c_departements`
--
ALTER TABLE `erp_c_departements`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1838;

--
-- AUTO_INCREMENT pour la table `erp_c_ecotaxe`
--
ALTER TABLE `erp_c_ecotaxe`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT pour la table `erp_c_email_senderprofile`
--
ALTER TABLE `erp_c_email_senderprofile`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_c_email_templates`
--
ALTER TABLE `erp_c_email_templates`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT pour la table `erp_c_field_list`
--
ALTER TABLE `erp_c_field_list`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_c_format_cards`
--
ALTER TABLE `erp_c_format_cards`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT pour la table `erp_c_forme_juridique`
--
ALTER TABLE `erp_c_forme_juridique`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=329;

--
-- AUTO_INCREMENT pour la table `erp_c_holiday_types`
--
ALTER TABLE `erp_c_holiday_types`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT pour la table `erp_c_hrm_public_holiday`
--
ALTER TABLE `erp_c_hrm_public_holiday`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT pour la table `erp_c_incoterms`
--
ALTER TABLE `erp_c_incoterms`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `erp_c_input_method`
--
ALTER TABLE `erp_c_input_method`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `erp_c_input_reason`
--
ALTER TABLE `erp_c_input_reason`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `erp_c_invoice_subtype`
--
ALTER TABLE `erp_c_invoice_subtype`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT pour la table `erp_c_lead_status`
--
ALTER TABLE `erp_c_lead_status`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `erp_c_paiement`
--
ALTER TABLE `erp_c_paiement`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT pour la table `erp_c_paper_format`
--
ALTER TABLE `erp_c_paper_format`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;

--
-- AUTO_INCREMENT pour la table `erp_c_payment_term`
--
ALTER TABLE `erp_c_payment_term`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT pour la table `erp_c_productbatch_qcstatus`
--
ALTER TABLE `erp_c_productbatch_qcstatus`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `erp_c_product_nature`
--
ALTER TABLE `erp_c_product_nature`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `erp_c_regions`
--
ALTER TABLE `erp_c_regions`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=311;

--
-- AUTO_INCREMENT pour la table `erp_c_revenuestamp`
--
ALTER TABLE `erp_c_revenuestamp`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22103;

--
-- AUTO_INCREMENT pour la table `erp_c_shipment_mode`
--
ALTER TABLE `erp_c_shipment_mode`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT pour la table `erp_c_shipment_package_type`
--
ALTER TABLE `erp_c_shipment_package_type`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_c_socialnetworks`
--
ALTER TABLE `erp_c_socialnetworks`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT pour la table `erp_c_ticket_category`
--
ALTER TABLE `erp_c_ticket_category`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `erp_c_ticket_resolution`
--
ALTER TABLE `erp_c_ticket_resolution`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `erp_c_ticket_severity`
--
ALTER TABLE `erp_c_ticket_severity`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `erp_c_ticket_type`
--
ALTER TABLE `erp_c_ticket_type`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `erp_c_transport_mode`
--
ALTER TABLE `erp_c_transport_mode`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `erp_c_tva`
--
ALTER TABLE `erp_c_tva`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22105;

--
-- AUTO_INCREMENT pour la table `erp_c_type_contact`
--
ALTER TABLE `erp_c_type_contact`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT pour la table `erp_c_type_fees`
--
ALTER TABLE `erp_c_type_fees`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT pour la table `erp_c_type_resource`
--
ALTER TABLE `erp_c_type_resource`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `erp_c_units`
--
ALTER TABLE `erp_c_units`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT pour la table `erp_c_ziptown`
--
ALTER TABLE `erp_c_ziptown`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_default_values`
--
ALTER TABLE `erp_default_values`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_delivery`
--
ALTER TABLE `erp_delivery`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_deliverydet`
--
ALTER TABLE `erp_deliverydet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_deliverydet_extrafields`
--
ALTER TABLE `erp_deliverydet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_delivery_extrafields`
--
ALTER TABLE `erp_delivery_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_document_model`
--
ALTER TABLE `erp_document_model`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_ecm_directories`
--
ALTER TABLE `erp_ecm_directories`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_ecm_directories_extrafields`
--
ALTER TABLE `erp_ecm_directories_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_ecm_files`
--
ALTER TABLE `erp_ecm_files`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_ecm_files_extrafields`
--
ALTER TABLE `erp_ecm_files_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_element_categorie`
--
ALTER TABLE `erp_element_categorie`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_element_contact`
--
ALTER TABLE `erp_element_contact`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_element_element`
--
ALTER TABLE `erp_element_element`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_element_resources`
--
ALTER TABLE `erp_element_resources`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_element_time`
--
ALTER TABLE `erp_element_time`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_emailcollector_emailcollector`
--
ALTER TABLE `erp_emailcollector_emailcollector`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_emailcollector_emailcollectoraction`
--
ALTER TABLE `erp_emailcollector_emailcollectoraction`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_emailcollector_emailcollectorfilter`
--
ALTER TABLE `erp_emailcollector_emailcollectorfilter`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_entrepot`
--
ALTER TABLE `erp_entrepot`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_entrepot_extrafields`
--
ALTER TABLE `erp_entrepot_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_establishment`
--
ALTER TABLE `erp_establishment`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_eventorganization_conferenceorboothattendee`
--
ALTER TABLE `erp_eventorganization_conferenceorboothattendee`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_eventorganization_conferenceorboothattendee_extrafields`
--
ALTER TABLE `erp_eventorganization_conferenceorboothattendee_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_events`
--
ALTER TABLE `erp_events`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_event_element`
--
ALTER TABLE `erp_event_element`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_expedition`
--
ALTER TABLE `erp_expedition`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_expeditiondet`
--
ALTER TABLE `erp_expeditiondet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_expeditiondet_batch`
--
ALTER TABLE `erp_expeditiondet_batch`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_expeditiondet_extrafields`
--
ALTER TABLE `erp_expeditiondet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_expedition_extrafields`
--
ALTER TABLE `erp_expedition_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_expedition_package`
--
ALTER TABLE `erp_expedition_package`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_expensereport`
--
ALTER TABLE `erp_expensereport`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_expensereport_det`
--
ALTER TABLE `erp_expensereport_det`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_expensereport_extrafields`
--
ALTER TABLE `erp_expensereport_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_export_model`
--
ALTER TABLE `erp_export_model`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_extrafields`
--
ALTER TABLE `erp_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture`
--
ALTER TABLE `erp_facture`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facturedet`
--
ALTER TABLE `erp_facturedet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facturedet_extrafields`
--
ALTER TABLE `erp_facturedet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facturedet_rec`
--
ALTER TABLE `erp_facturedet_rec`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facturedet_rec_extrafields`
--
ALTER TABLE `erp_facturedet_rec_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_extrafields`
--
ALTER TABLE `erp_facture_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_fourn`
--
ALTER TABLE `erp_facture_fourn`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_fourn_det`
--
ALTER TABLE `erp_facture_fourn_det`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_fourn_det_extrafields`
--
ALTER TABLE `erp_facture_fourn_det_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_fourn_det_rec`
--
ALTER TABLE `erp_facture_fourn_det_rec`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_fourn_det_rec_extrafields`
--
ALTER TABLE `erp_facture_fourn_det_rec_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_fourn_extrafields`
--
ALTER TABLE `erp_facture_fourn_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_fourn_rec`
--
ALTER TABLE `erp_facture_fourn_rec`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_fourn_rec_extrafields`
--
ALTER TABLE `erp_facture_fourn_rec_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_rec`
--
ALTER TABLE `erp_facture_rec`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_facture_rec_extrafields`
--
ALTER TABLE `erp_facture_rec_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_fichinter`
--
ALTER TABLE `erp_fichinter`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_fichinterdet`
--
ALTER TABLE `erp_fichinterdet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_fichinterdet_extrafields`
--
ALTER TABLE `erp_fichinterdet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_fichinterdet_rec`
--
ALTER TABLE `erp_fichinterdet_rec`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_fichinter_extrafields`
--
ALTER TABLE `erp_fichinter_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_fichinter_rec`
--
ALTER TABLE `erp_fichinter_rec`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_holiday`
--
ALTER TABLE `erp_holiday`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_holiday_config`
--
ALTER TABLE `erp_holiday_config`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `erp_holiday_extrafields`
--
ALTER TABLE `erp_holiday_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_holiday_logs`
--
ALTER TABLE `erp_holiday_logs`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_import_model`
--
ALTER TABLE `erp_import_model`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_links`
--
ALTER TABLE `erp_links`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_localtax`
--
ALTER TABLE `erp_localtax`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_mailing_unsubscribe`
--
ALTER TABLE `erp_mailing_unsubscribe`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_menu`
--
ALTER TABLE `erp_menu`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_mrp_mo`
--
ALTER TABLE `erp_mrp_mo`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_mrp_mo_extrafields`
--
ALTER TABLE `erp_mrp_mo_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_mrp_production`
--
ALTER TABLE `erp_mrp_production`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_mrp_production_extrafields`
--
ALTER TABLE `erp_mrp_production_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_multicurrency`
--
ALTER TABLE `erp_multicurrency`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_multicurrency_rate`
--
ALTER TABLE `erp_multicurrency_rate`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_notify`
--
ALTER TABLE `erp_notify`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_notify_def`
--
ALTER TABLE `erp_notify_def`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_notify_def_object`
--
ALTER TABLE `erp_notify_def_object`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_oauth_state`
--
ALTER TABLE `erp_oauth_state`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_oauth_token`
--
ALTER TABLE `erp_oauth_token`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_object_lang`
--
ALTER TABLE `erp_object_lang`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_onlinesignature`
--
ALTER TABLE `erp_onlinesignature`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_overwrite_trans`
--
ALTER TABLE `erp_overwrite_trans`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_paiement`
--
ALTER TABLE `erp_paiement`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_paiementcharge`
--
ALTER TABLE `erp_paiementcharge`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_paiementfourn`
--
ALTER TABLE `erp_paiementfourn`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_paiementfourn_facturefourn`
--
ALTER TABLE `erp_paiementfourn_facturefourn`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_paiement_facture`
--
ALTER TABLE `erp_paiement_facture`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_payment_donation`
--
ALTER TABLE `erp_payment_donation`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_payment_expensereport`
--
ALTER TABLE `erp_payment_expensereport`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_payment_loan`
--
ALTER TABLE `erp_payment_loan`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_payment_salary`
--
ALTER TABLE `erp_payment_salary`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_payment_various`
--
ALTER TABLE `erp_payment_various`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_payment_vat`
--
ALTER TABLE `erp_payment_vat`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_pos_cash_fence`
--
ALTER TABLE `erp_pos_cash_fence`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_prelevement`
--
ALTER TABLE `erp_prelevement`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_prelevement_bons`
--
ALTER TABLE `erp_prelevement_bons`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_prelevement_demande`
--
ALTER TABLE `erp_prelevement_demande`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_prelevement_lignes`
--
ALTER TABLE `erp_prelevement_lignes`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_prelevement_rejet`
--
ALTER TABLE `erp_prelevement_rejet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_printing`
--
ALTER TABLE `erp_printing`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product`
--
ALTER TABLE `erp_product`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_association`
--
ALTER TABLE `erp_product_association`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_attribute`
--
ALTER TABLE `erp_product_attribute`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_attribute_combination`
--
ALTER TABLE `erp_product_attribute_combination`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_attribute_combination2val`
--
ALTER TABLE `erp_product_attribute_combination2val`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_attribute_combination_price_level`
--
ALTER TABLE `erp_product_attribute_combination_price_level`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_attribute_value`
--
ALTER TABLE `erp_product_attribute_value`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_batch`
--
ALTER TABLE `erp_product_batch`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_customer_price`
--
ALTER TABLE `erp_product_customer_price`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_customer_price_log`
--
ALTER TABLE `erp_product_customer_price_log`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_extrafields`
--
ALTER TABLE `erp_product_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_fournisseur_price`
--
ALTER TABLE `erp_product_fournisseur_price`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_fournisseur_price_extrafields`
--
ALTER TABLE `erp_product_fournisseur_price_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_fournisseur_price_log`
--
ALTER TABLE `erp_product_fournisseur_price_log`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_lang`
--
ALTER TABLE `erp_product_lang`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_lot`
--
ALTER TABLE `erp_product_lot`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_lot_extrafields`
--
ALTER TABLE `erp_product_lot_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_price`
--
ALTER TABLE `erp_product_price`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_pricerules`
--
ALTER TABLE `erp_product_pricerules`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_price_by_qty`
--
ALTER TABLE `erp_product_price_by_qty`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_stock`
--
ALTER TABLE `erp_product_stock`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_product_warehouse_properties`
--
ALTER TABLE `erp_product_warehouse_properties`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_projet`
--
ALTER TABLE `erp_projet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_projet_extrafields`
--
ALTER TABLE `erp_projet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_projet_task`
--
ALTER TABLE `erp_projet_task`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_projet_task_extrafields`
--
ALTER TABLE `erp_projet_task_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_propal`
--
ALTER TABLE `erp_propal`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_propaldet`
--
ALTER TABLE `erp_propaldet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_propaldet_extrafields`
--
ALTER TABLE `erp_propaldet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_propal_extrafields`
--
ALTER TABLE `erp_propal_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_propal_merge_pdf_product`
--
ALTER TABLE `erp_propal_merge_pdf_product`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_reception`
--
ALTER TABLE `erp_reception`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_reception_extrafields`
--
ALTER TABLE `erp_reception_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_resource`
--
ALTER TABLE `erp_resource`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_resource_extrafields`
--
ALTER TABLE `erp_resource_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_salary`
--
ALTER TABLE `erp_salary`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_salary_extrafields`
--
ALTER TABLE `erp_salary_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe`
--
ALTER TABLE `erp_societe`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe_account`
--
ALTER TABLE `erp_societe_account`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe_commerciaux`
--
ALTER TABLE `erp_societe_commerciaux`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe_contacts`
--
ALTER TABLE `erp_societe_contacts`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe_extrafields`
--
ALTER TABLE `erp_societe_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe_prices`
--
ALTER TABLE `erp_societe_prices`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe_remise`
--
ALTER TABLE `erp_societe_remise`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe_remise_except`
--
ALTER TABLE `erp_societe_remise_except`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe_remise_supplier`
--
ALTER TABLE `erp_societe_remise_supplier`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_societe_rib`
--
ALTER TABLE `erp_societe_rib`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_socpeople`
--
ALTER TABLE `erp_socpeople`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_socpeople_extrafields`
--
ALTER TABLE `erp_socpeople_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_stock_mouvement`
--
ALTER TABLE `erp_stock_mouvement`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_stock_mouvement_extrafields`
--
ALTER TABLE `erp_stock_mouvement_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_subscription`
--
ALTER TABLE `erp_subscription`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_supplier_proposal`
--
ALTER TABLE `erp_supplier_proposal`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_supplier_proposaldet`
--
ALTER TABLE `erp_supplier_proposaldet`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_supplier_proposaldet_extrafields`
--
ALTER TABLE `erp_supplier_proposaldet_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_supplier_proposal_extrafields`
--
ALTER TABLE `erp_supplier_proposal_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_tva`
--
ALTER TABLE `erp_tva`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_user`
--
ALTER TABLE `erp_user`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `erp_usergroup`
--
ALTER TABLE `erp_usergroup`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_usergroup_extrafields`
--
ALTER TABLE `erp_usergroup_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_usergroup_rights`
--
ALTER TABLE `erp_usergroup_rights`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_usergroup_user`
--
ALTER TABLE `erp_usergroup_user`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_user_alert`
--
ALTER TABLE `erp_user_alert`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_user_employment`
--
ALTER TABLE `erp_user_employment`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_user_extrafields`
--
ALTER TABLE `erp_user_extrafields`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_user_rib`
--
ALTER TABLE `erp_user_rib`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `erp_user_rights`
--
ALTER TABLE `erp_user_rights`
  MODIFY `rowid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- Contraintes pour la table `erp_accounting_account`
--
ALTER TABLE `erp_accounting_account`
...
--
-- Contraintes pour la table `erp_adherent`
--
ALTER TABLE `erp_adherent`
...
--
-- Contraintes pour la table `erp_bank_account`
--
ALTER TABLE `erp_bank_account`
...
--
-- Contraintes pour la table `erp_categorie_actioncomm`
--
ALTER TABLE `erp_categorie_actioncomm`
...
--
-- Contraintes pour la table `erp_categorie_contact`
--
ALTER TABLE `erp_categorie_contact`
...
--
-- Contraintes pour la table `erp_categorie_fournisseur`
--
ALTER TABLE `erp_categorie_fournisseur`
...
--
-- Contraintes pour la table `erp_categorie_product`
--
ALTER TABLE `erp_categorie_product`
...
--
-- Contraintes pour la table `erp_categorie_project`
--
ALTER TABLE `erp_categorie_project`
...
--
-- Contraintes pour la table `erp_categorie_societe`
--
ALTER TABLE `erp_categorie_societe`
...
--
-- Contraintes pour la table `erp_categorie_user`
--
ALTER TABLE `erp_categorie_user`
...
--
-- Contraintes pour la table `erp_categorie_warehouse`
--
ALTER TABLE `erp_categorie_warehouse`
...
--
-- Contraintes pour la table `erp_commande`
--
ALTER TABLE `erp_commande`
...
--
-- Contraintes pour la table `erp_commandedet`
--
ALTER TABLE `erp_commandedet`
...
--
-- Contraintes pour la table `erp_contratdet`
--
ALTER TABLE `erp_contratdet`
...
--
-- Contraintes pour la table `erp_delivery`
--
ALTER TABLE `erp_delivery`
...
--
-- Contraintes pour la table `erp_element_categorie`
--
ALTER TABLE `erp_element_categorie`
  ADD CONSTRAINT `fk_element_categorie_fk_categorie` FOREIGN KEY (`fk_categorie`) REFERENCES `erp_categorie` (`rowid`);

--
-- Contraintes pour la table `erp_element_contact`
--
ALTER TABLE `erp_element_contact`
  ADD CONSTRAINT `fk_element_contact_fk_c_type_contact` FOREIGN KEY (`fk_c_type_contact`) REFERENCES `erp_c_type_contact` (`rowid`);

--
-- Contraintes pour la table `erp_emailcollector_emailcollectoraction`
--
ALTER TABLE `erp_emailcollector_emailcollectoraction`
...
--
-- Contraintes pour la table `erp_emailcollector_emailcollectorfilter`
--
ALTER TABLE `erp_emailcollector_emailcollectorfilter`
...
--
-- Contraintes pour la table `erp_expedition`
--
ALTER TABLE `erp_expedition`
...
--
-- Contraintes pour la table `erp_facturedet`
--
ALTER TABLE `erp_facturedet`
...
--
-- Contraintes pour la table `erp_facture_fourn_det`
--
ALTER TABLE `erp_facture_fourn_det`
...
--
-- Contraintes pour la table `erp_facture_fourn_det_rec`
--
ALTER TABLE `erp_facture_fourn_det_rec`
  ADD CONSTRAINT `fk_facture_fourn_det_rec_fk_unit` FOREIGN KEY (`fk_unit`) REFERENCES `erp_c_units` (`rowid`);

--
-- Contraintes pour la table `erp_facture_fourn_rec`
--
ALTER TABLE `erp_facture_fourn_rec`
  ADD CONSTRAINT `fk_facture_fourn_rec_fk_projet` FOREIGN KEY (`fk_projet`) REFERENCES `erp_projet` (`rowid`),
  ADD CONSTRAINT `fk_facture_fourn_rec_fk_soc` FOREIGN KEY (`fk_soc`) REFERENCES `erp_societe` (`rowid`),
  ADD CONSTRAINT `fk_facture_fourn_rec_fk_user_author` FOREIGN KEY (`fk_user_author`) REFERENCES `erp_user` (`rowid`);

--
-- Contraintes pour la table `erp_facture_rec`
--
ALTER TABLE `erp_facture_rec`
...
--
-- Contraintes pour la table `erp_paiement_facture`
--
ALTER TABLE `erp_paiement_facture`
...
--
-- Contraintes pour la table `erp_payment_salary`
--
ALTER TABLE `erp_payment_salary`
  ADD CONSTRAINT `fk_payment_salary_user` FOREIGN KEY (`fk_user`) REFERENCES `erp_user` (`rowid`);

--
-- Contraintes pour la table `erp_prelevement`
--
ALTER TABLE `erp_prelevement`
  ADD CONSTRAINT `fk_prelevement_fk_prelevement_lignes` FOREIGN KEY (`fk_prelevement_lignes`) REFERENCES `erp_prelevement_lignes` (`rowid`);

--
-- Contraintes pour la table `erp_prelevement_lignes`
--
ALTER TABLE `erp_prelevement_lignes`
...
--
-- Contraintes pour la table `erp_product`
--
ALTER TABLE `erp_product`
...
--
-- Contraintes pour la table `erp_product_fournisseur_price`
--
ALTER TABLE `erp_product_fournisseur_price`
...
--
-- Contraintes pour la table `erp_product_lang`
--
ALTER TABLE `erp_product_lang`
  ADD CONSTRAINT `fk_product_lang_fk_product` FOREIGN KEY (`fk_product`) REFERENCES `erp_product` (`rowid`);

--
-- Contraintes pour la table `erp_product_price`
--
ALTER TABLE `erp_product_price`
  ADD CONSTRAINT `fk_product_price_user_author` FOREIGN KEY (`fk_product`) REFERENCES `erp_product` (`rowid`);

--
-- Contraintes pour la table `erp_product_price_by_qty`
--
ALTER TABLE `erp_product_price_by_qty`
  ADD CONSTRAINT `fk_product_price_by_qty_fk_product_price` FOREIGN KEY (`fk_product_price`) REFERENCES `erp_product_price` (`rowid`);

--
-- Contraintes pour la table `erp_product_stock`
--
ALTER TABLE `erp_product_stock`
  ADD CONSTRAINT `fk_entrepot_entrepot_rowid` FOREIGN KEY (`fk_entrepot`) REFERENCES `erp_entrepot` (`rowid`),
  ADD CONSTRAINT `fk_product_product_rowid` FOREIGN KEY (`fk_product`) REFERENCES `erp_product` (`rowid`);

--
-- Contraintes pour la table `erp_projet`
--
ALTER TABLE `erp_projet`
  ADD CONSTRAINT `fk_projet_fk_soc` FOREIGN KEY (`fk_soc`) REFERENCES `erp_societe` (`rowid`);

--
-- Contraintes pour la table `erp_projet_task`
--
ALTER TABLE `erp_projet_task`
...
--
-- Contraintes pour la table `erp_propal`
--
ALTER TABLE `erp_propal`
...
--
-- Contraintes pour la table `erp_propaldet`
--
ALTER TABLE `erp_propaldet`
...
--
-- Contraintes pour la table `erp_reception`
--
ALTER TABLE `erp_reception`
...
--
-- Contraintes pour la table `erp_societe_remise_except`
--
ALTER TABLE `erp_societe_remise_except`
...
--
-- Contraintes pour la table `erp_supplier_proposaldet`
--
ALTER TABLE `erp_supplier_proposaldet`

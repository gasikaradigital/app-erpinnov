    ...
    public function store()
    {
        ...
        try {
            ...
            $this->newInstanceInfo = [
                ...
                'url' => "http://" . $instanceDetails['url'],
                'api_key' => $api_key_dolibarr,
            ];

            $newUsersInnov = new CreateUsersInnov();

            $newUsersInnov->insertIntoOtherDb($instance->name, 'test@example.com', $api_key_dolibarr, $password_dolibarr, $this->newInstanceInfo['url']);

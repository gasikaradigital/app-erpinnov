                        ...
                        <form wire:submit.prevent="store">
                            ...
                            <div class="content">
                                ...
                                <div class="row g-6 mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label" for="nif">NIF <small>(facultatif)</small></label>
                                        <input type="text" id="nif" wire:model="nif" class="form-control multi-steps-pincode" placeholder="4789206500022" maxlength="18"/>

          ...
          <div class="d-flex align-items-end row">
            <div class="col-7">
              <div class="card-body text-nowrap">
                <h5 class="card-title mb-0">{{ $user->name }}/{{ $instance->entreprise->name }} 🎉</h5>
                <p class="mb-2">{{ $instance->name }}</p>
            ...
            <div class="row gy-3">
              <div class="col-md-3 col-6">
                <div class="d-flex align-items-center">
                  ...
                  <div class="card-info">
                    <h5 class="mb-0">{{ $instanceCount }} </h5>
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3 pb-1">
                          <div class="d-flex align-items-start">
                            ...
                            <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                              ...
                              <div class="me-2">
                                <h6 class="mb-0">{{ $user->name }}/{{ $instance->entreprise->name }}</h6>
                        ...
                        <li class="mb-3 pb-1">
                          <div class="d-flex align-items-start">
                            ...
                            <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                              <div class="me-2">
                                <h6 class="mb-0"><div class="ms-3 badge bg-label-success">{{$instance->status}} </div></h6>
                        ...
                        <li class="mb-3 pb-1">
                          <div class="d-flex align-items-start">
                            ...
                            <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                              <div class="me-2">
                                <h6 class="mb-0">{{ $instance->created_at->format('d-m-Y')}}</h6>
            ...
            <table class="table datatable-invoice border-top">
              ...
              @if($paiements)
                ...
                <tr class="odd">
                    ...
                    <td>
                        <a href="{{ route('facture.detail', ['id_payment' =>$paiement->id, 'id_instance' => $instance->id]) }}">
                            <button
                ...
                @else
                <tr class="odd">
                    <td colspan="5">Pas de paiements effectué</td>
                </tr>
              @endif
              </tbody>
